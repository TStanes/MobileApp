...
[Table("PartyCreditLimitM")]
public partial class PartyCreditLimitM
{
    [Key]
    ...
    [InverseProperty("PartyCreditLimitMs")]
    ...
    [ForeignKey("FinancialYearUid")]
    [InverseProperty("PartyCreditLimitMs")]
    public virtual FinancialYearM FinancialYearU { get; set; } = null!;

    [InverseProperty("PartyCreditLimitU")]
    public virtual ICollection<PartyCreditLimitHistory> PartyCreditLimitHistories { get; set; } = new List<PartyCreditLimitHistory>();
