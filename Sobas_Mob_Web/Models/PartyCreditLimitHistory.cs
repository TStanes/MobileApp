...
[Table("PartyCreditLimitHistory")]
public partial class PartyCreditLimitHistory
{
    [Key]
    [Column("PartyCreditLimitHistoryUID")]
    public Guid PartyCreditLimitHistoryUid { get; set; }
    ...
    [ForeignKey("PartyCreditLimitUid")]
    [InverseProperty("PartyCreditLimitHistories")]
    public virtual PartyCreditLimitM PartyCreditLimitU { get; set; } = null!;
}
