...
public partial class VwInventory
{
    ...
    [StringLength(50)]
    [Unicode(false)]
    public string ItemStatusDescription { get; set; } = null!;
    ...
    [Column("LEDHrEduCessPer", TypeName = "decimal(18, 3)")]
    public decimal? LedhrEduCessPer { get; set; }

    [Column("LEDHrEduCessAmt", TypeName = "decimal(18, 3)")]
    public decimal? LedhrEduCessAmt { get; set; }
    ...
    [StringLength(50)]
    [Unicode(false)]
    public string? AttendedByCode { get; set; }
    ...
    [StringLength(50)]
    [Unicode(false)]
    public string? Uom1code { get; set; }

    [Column("UOM1Desc")]
    [StringLength(150)]
    [Unicode(false)]
    public string? Uom1desc { get; set; }

    [Column("UOM2Code")]
    [StringLength(50)]
    [Unicode(false)]
    public string? Uom2code { get; set; }
    ...
    [StringLength(50)]
    [Unicode(false)]
    public string EdsalesSerialNo { get; set; } = null!;
    ...
    [Column("ReceivingBranchGSTNo")]
    [StringLength(100)]
    [Unicode(false)]
    public string? ReceivingBranchGstno { get; set; }
