...
[Table("RejectedInventoryTransList")]
public partial class RejectedInventoryTransList
{
    [Key]
    ...
    [InverseProperty("RejectedInventoryTransLists")]
    public virtual RejectedInventoryTran InventoryTransU { get; set; } = null!;
}
