...
[Table("RejectedItemM")]
public partial class RejectedItemM
{
    [Key]
    [Column("ItemUID")]
    ...
    public virtual ICollection<RejectedItemDivisionLink> RejectedItemDivisionLinks { get; set; } = new List<RejectedItemDivisionLink>();

    [InverseProperty("ItemU")]
    public virtual ICollection<RejectedItemDivisionPrincipleLink> RejectedItemDivisionPrincipleLinks { get; set; } = new List<RejectedItemDivisionPrincipleLink>();

    [InverseProperty("ItemU")]
    public virtual ICollection<RejectedItemRequestPack> RejectedItemRequestPacks { get; set; } = new List<RejectedItemRequestPack>();
}
