...
[Table("PartyOtherDetailsHOApproval")]
public partial class PartyOtherDetailsHoapproval
{
    [Key]
    [Column("ApprovedPartyOtherDetailUID")]
    public Guid ApprovedPartyOtherDetailUid { get; set; }
