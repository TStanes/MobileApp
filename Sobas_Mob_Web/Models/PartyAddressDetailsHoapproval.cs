...
[Table("PartyAddressDetailsHOApproval")]
public partial class PartyAddressDetailsHoapproval
{
    [Key]
    [Column("ApprovedPartyAddressDetailUID")]
    public Guid ApprovedPartyAddressDetailUid { get; set; }
