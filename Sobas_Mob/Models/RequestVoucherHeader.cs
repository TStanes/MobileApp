...
[Table("RequestVoucherHeader")]
[Index("DivisionUid", "VoucherDate", "TransactionTypeCode", "StatusUid", "IsActive", Name = "IX_DiviTTStatusISactive")]
[Index("VoucherDate", Name = "IX_RequestVoucherHeader_VoucherDate_Includes")]
[Index("VoucherNo", "IsActive", Name = "IX_Vrno_Isactive")]
public partial class RequestVoucherHeader
{
    [Key]
    [Column("RequestVoucherHeaderUID")]
    public Guid RequestVoucherHeaderUid { get; set; }
