...
[Keyless]
public partial class VwPurchaseInvoiceforViewing
{
    ...
    [Column("TotalED", TypeName = "decimal(18, 5)")]
    public decimal TotalEd { get; set; }

    [Column("TotalCESS", TypeName = "decimal(18, 5)")]
    public decimal TotalCess { get; set; }

    [Column("TotalVAT", TypeName = "decimal(18, 5)")]
    public decimal TotalVat { get; set; }

    [Column("TotalVATCESS", TypeName = "decimal(18, 5)")]
    ...
    [Column("GRNQty", TypeName = "decimal(18, 3)")]
    public decimal Grnqty { get; set; }

    [Column("GRNReceiptReturnQty", TypeName = "decimal(18, 3)")]
    public decimal? GrnreceiptReturnQty { get; set; }

    [Column("GRNCarrierShortages", TypeName = "decimal(18, 3)")]
    public decimal GrncarrierShortages { get; set; }

    [Column("GRNMoistureqty", TypeName = "decimal(18, 3)")]
    public decimal Grnmoistureqty { get; set; }

    [Column("GRNNetQty", TypeName = "decimal(18, 3)")]
