...
[Table("InOutRegister_New")]
[Index("BranchUid", "TransactionType", "ItemUid", Name = "IX_InOutRegister_New_BranchUID_TransactionType_ItemUID_Includes")]
[Index("DocDate", Name = "IX_InOutRegister_New_DocDate_Includes")]
[Index("IsActive", "DocDate", Name = "IX_InOutRegister_New_IsActive_DocDate_Includes")]
[Index("StockMonth", "StockYear", Name = "IX_InOutRegister_New_StockMonth_StockYear_Includes")]
[Index("DocDate", "TransactionType", Name = "IX_Transactiontypecode_Docdate")]
[Index("StockYear", "BranchUid", "ItemUid", "TransactionType", "Sno", "RowUid", "DocDate", Name = "_dta_index_InOutRegister_New_7_1570260799__K37_K3_K18_K10_K27_K1_K9_20")]
public partial class InOutRegisterNew
{
    [Key]
    [Column("RowUID")]
