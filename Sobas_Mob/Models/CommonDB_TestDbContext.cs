...
public partial class CommonDB_TestDbContext : DbContext
{
    ...
    public virtual DbSet<AaPartyShipTo> AaPartyShipTos { get; set; }

    public virtual DbSet<AaVoucherDetail> AaVoucherDetails { get; set; }

    public virtual DbSet<AccountGroupM> AccountGroupMs { get; set; }

    public virtual DbSet<AccountM> AccountMs { get; set; }

    public virtual DbSet<AccountMextn> AccountMextns { get; set; }

    public virtual DbSet<AccountTypeM> AccountTypeMs { get; set; }

    public virtual DbSet<AccountmBackupUnused> AccountmBackupUnuseds { get; set; }

    public virtual DbSet<ActiveAreaSoMappingAppDatum> ActiveAreaSoMappingAppData { get; set; }

    public virtual DbSet<Activeemployee> Activeemployees { get; set; }

    public virtual DbSet<ActualStatusM> ActualStatusMs { get; set; }

    public virtual DbSet<Adj> Adjs { get; set; }

    public virtual DbSet<Adj1> Adj1s { get; set; }

    public virtual DbSet<AffectedAccountTypesM> AffectedAccountTypesMs { get; set; }

    public virtual DbSet<AlertMessageM> AlertMessageMs { get; set; }

    public virtual DbSet<AlertReceiptM> AlertReceiptMs { get; set; }

    public virtual DbSet<AlertReceiptMbackup> AlertReceiptMbackups { get; set; }

    public virtual DbSet<AlertReceiptMbackupforMvg> AlertReceiptMbackupforMvgs { get; set; }
    ...
    public virtual DbSet<AreaSoitemGroupBackup> AreaSoitemGroupBackups { get; set; }

    public virtual DbSet<AreaSomapping> AreaSomappings { get; set; }

    public virtual DbSet<Attendance> Attendances { get; set; }

    public virtual DbSet<BalanceSheetScheduleDetail> BalanceSheetScheduleDetails { get; set; }
    ...
    public virtual DbSet<BatchStockDetail> BatchStockDetails { get; set; }

    public virtual DbSet<BceEmail> BceEmails { get; set; }
    ...
    public virtual DbSet<BcebankAccountM> BcebankAccountMs { get; set; }
    ...
    public virtual DbSet<BdlistHistory> BdlistHistories { get; set; }

    public virtual DbSet<BdlistM> BdlistMs { get; set; }

    public virtual DbSet<Bdstatus> Bdstatuses { get; set; }

    public virtual DbSet<BiProductRate> BiProductRates { get; set; }

    public virtual DbSet<BillPassing> BillPassings { get; set; }

    public virtual DbSet<BioProductDetail> BioProductDetails { get; set; }

    public virtual DbSet<BrInventoryOpnRate> BrInventoryOpnRates { get; set; }
    ...
    public virtual DbSet<ChangeFlag> ChangeFlags { get; set; }

    public virtual DbSet<CheckBlockingQuery> CheckBlockingQueries { get; set; }
    ...
    public virtual DbSet<Cipstock> Cipstocks { get; set; }

    public virtual DbSet<Cl> Cls { get; set; }

    public virtual DbSet<ClosingMvg> ClosingMvgs { get; set; }

    public virtual DbSet<ClosingQtyTemp> ClosingQtyTemps { get; set; }

    public virtual DbSet<ClosingStockDataAudit> ClosingStockDataAudits { get; set; }

    public virtual DbSet<ClosingStockMovingAvg> ClosingStockMovingAvgs { get; set; }

    public virtual DbSet<ClosingStockStatusGst> ClosingStockStatusGsts { get; set; }

    public virtual DbSet<ClosingStockVal> ClosingStockVals { get; set; }

    public virtual DbSet<Clst> Clsts { get; set; }

    public virtual DbSet<CommissionM> CommissionMs { get; set; }

    public virtual DbSet<CommissionMappingBranch> CommissionMappingBranches { get; set; }

    public virtual DbSet<CommissionQtyLift> CommissionQtyLifts { get; set; }

    public virtual DbSet<CommissionTargetLink> CommissionTargetLinks { get; set; }

    public virtual DbSet<CommissionValueLift> CommissionValueLifts { get; set; }

    public virtual DbSet<CommodityCodeM> CommodityCodeMs { get; set; }

    public virtual DbSet<CommonToSyncDataCount> CommonToSyncDataCounts { get; set; }

    public virtual DbSet<CompanyM> CompanyMs { get; set; }

    public virtual DbSet<ConCustomerUpload> ConCustomerUploads { get; set; }

    public virtual DbSet<ConDivisionSegment> ConDivisionSegments { get; set; }

    public virtual DbSet<ConEmployeeList> ConEmployeeLists { get; set; }

    public virtual DbSet<ConEmployeeListRef> ConEmployeeListRefs { get; set; }

    public virtual DbSet<ConGrowerUpload> ConGrowerUploads { get; set; }

    public virtual DbSet<ConGrowersCropVareity> ConGrowersCropVareities { get; set; }

    public virtual DbSet<ConGrowersEmployeeUniqueList> ConGrowersEmployeeUniqueLists { get; set; }

    public virtual DbSet<ConGrowersFarmer> ConGrowersFarmers { get; set; }

    public virtual DbSet<ConGrowersOfficeHierarchy> ConGrowersOfficeHierarchies { get; set; }

    public virtual DbSet<ConGrowersSalesDatum> ConGrowersSalesData { get; set; }

    public virtual DbSet<ConGrowersTransactionfile> ConGrowersTransactionfiles { get; set; }

    public virtual DbSet<ConOfficeHierarchy> ConOfficeHierarchies { get; set; }

    public virtual DbSet<ConPpalist> ConPpalists { get; set; }

    public virtual DbSet<ConSalesOsColl> ConSalesOsColls { get; set; }

    public virtual DbSet<ConSalesOsCollParty> ConSalesOsCollParties { get; set; }

    public virtual DbSet<ConStaffDivisionUpload> ConStaffDivisionUploads { get; set; }

    public virtual DbSet<ConsignmentDetail> ConsignmentDetails { get; set; }

    public virtual DbSet<ConsignmentGrnstatus> ConsignmentGrnstatuses { get; set; }
    ...
    public virtual DbSet<ControlCodeScheduleM> ControlCodeScheduleMs { get; set; }
    ...
    public virtual DbSet<CreditLimitHistory> CreditLimitHistories { get; set; }

    public virtual DbSet<CrlmtReq> CrlmtReqs { get; set; }

    public virtual DbSet<CugList> CugLists { get; set; }
    ...
    public virtual DbSet<CurrentRec> CurrentRecs { get; set; }

    public virtual DbSet<DailyCheckedList> DailyCheckedLists { get; set; }

    public virtual DbSet<DateChangeHistory> DateChangeHistories { get; set; }
    ...
    public virtual DbSet<DealerCount> DealerCounts { get; set; }

    public virtual DbSet<DealerDeposit> DealerDeposits { get; set; }

    public virtual DbSet<DealerDepositwithoutRef> DealerDepositwithoutRefs { get; set; }

    public virtual DbSet<DealerItemRate> DealerItemRates { get; set; }

    public virtual DbSet<DebiteNoteBaseTbl> DebiteNoteBaseTbls { get; set; }
    ...
    public virtual DbSet<DepreciationM> DepreciationMs { get; set; }
    ...
    public virtual DbSet<DiscountPercentageallowedBackup> DiscountPercentageallowedBackups { get; set; }
    ...
    public virtual DbSet<DistrictStateMapping> DistrictStateMappings { get; set; }
    ...
    public virtual DbSet<DivisionServiceDivisionLookupM> DivisionServiceDivisionLookupMs { get; set; }

    public virtual DbSet<Divupd> Divupds { get; set; }
    ...
    public virtual DbSet<DumpAsset> DumpAssets { get; set; }

    public virtual DbSet<DumpExpense> DumpExpenses { get; set; }

    public virtual DbSet<DumpIncome> DumpIncomes { get; set; }

    public virtual DbSet<DumpLiability> DumpLiabilities { get; set; }

    public virtual DbSet<Earlycutoff> Earlycutoffs { get; set; }
    ...
    public virtual DbSet<EdmasterOld> EdmasterOlds { get; set; }

    public virtual DbSet<Edposting> Edpostings { get; set; }
    ...
    public virtual DbSet<EinvIrnnotGenerated> EinvIrnnotGenerateds { get; set; }

    public virtual DbSet<EinvOwnId> EinvOwnIds { get; set; }

    public virtual DbSet<EinvoiceBankInfo> EinvoiceBankInfos { get; set; }

    public virtual DbSet<EinvoiceDataM> EinvoiceDataMs { get; set; }

    public virtual DbSet<EinvoiceDataTestM> EinvoiceDataTestMs { get; set; }
    ...
    public virtual DbSet<ExpenseApprovalHierarchy> ExpenseApprovalHierarchies { get; set; }

    public virtual DbSet<ExpenseInstalled> ExpenseInstalleds { get; set; }

    public virtual DbSet<ExpenseKeyed> ExpenseKeyeds { get; set; }

    public virtual DbSet<Expenseskeyed> Expenseskeyeds { get; set; }

    public virtual DbSet<ExportMonSale> ExportMonSales { get; set; }

    public virtual DbSet<FacodeSlNo> FacodeSlNos { get; set; }

    public virtual DbSet<FarmersM> FarmersMs { get; set; }

    public virtual DbSet<FassetClassM> FassetClassMs { get; set; }

    public virtual DbSet<FassetGroupM> FassetGroupMs { get; set; }

    public virtual DbSet<FassetItemM> FassetItemMs { get; set; }

    public virtual DbSet<FassetLocationTransfer> FassetLocationTransfers { get; set; }

    public virtual DbSet<FassetSegmentM> FassetSegmentMs { get; set; }

    public virtual DbSet<FassetSubGroupM> FassetSubGroupMs { get; set; }

    public virtual DbSet<FassetTransDetail> FassetTransDetails { get; set; }

    public virtual DbSet<FassetTransDetailExtn> FassetTransDetailExtns { get; set; }

    public virtual DbSet<FassetTransHeader> FassetTransHeaders { get; set; }

    public virtual DbSet<FassetTransSlNo> FassetTransSlNos { get; set; }

    public virtual DbSet<Favoucher> Favouchers { get; set; }

    public virtual DbSet<FekycmasterM> FekycmasterMs { get; set; }

    public virtual DbSet<FekycmasterMBKup> FekycmasterMBKups { get; set; }

    public virtual DbSet<FekycmasterMTemplate> FekycmasterMTemplates { get; set; }
    ...
    public virtual DbSet<FinalBankDelete> FinalBankDeletes { get; set; }

    public virtual DbSet<FinancialYear> FinancialYears { get; set; }

    public virtual DbSet<FinancialYearM> FinancialYearMs { get; set; }

    public virtual DbSet<Fiveyearcon> Fiveyearcons { get; set; }
    ...
    public virtual DbSet<FreightHdr> FreightHdrs { get; set; }

    public virtual DbSet<FreightList> FreightLists { get; set; }

    public virtual DbSet<FreightListExtn> FreightListExtns { get; set; }

    public virtual DbSet<FreightSlNo> FreightSlNos { get; set; }

    public virtual DbSet<FrieghtPaymentTypeM> FrieghtPaymentTypeMs { get; set; }

    public virtual DbSet<Frmaster> Frmasters { get; set; }

    public virtual DbSet<FrtCharge> FrtCharges { get; set; }

    public virtual DbSet<Frtposting> Frtpostings { get; set; }

    public virtual DbSet<FunReceivablesforHo> FunReceivablesforHos { get; set; }

    public virtual DbSet<GeneralLedgerView> GeneralLedgerViews { get; set; }

    public virtual DbSet<GitCorrection> GitCorrections { get; set; }

    public virtual DbSet<Gitcorrection1> Gitcorrections { get; set; }

    public virtual DbSet<GracePeriodForBackDaysEntry> GracePeriodForBackDaysEntries { get; set; }

    public virtual DbSet<GrnExempt> GrnExempts { get; set; }
    ...
    public virtual DbSet<GrossTemp> GrossTemps { get; set; }

    public virtual DbSet<GroupHeadEntriesDelete> GroupHeadEntriesDeletes { get; set; }

    public virtual DbSet<Gst1718SalesDatum> Gst1718SalesData { get; set; }

    public virtual DbSet<Gst1819SalesDatum> Gst1819SalesData { get; set; }

    public virtual DbSet<Gst1920SalesDatum> Gst1920SalesData { get; set; }

    public virtual DbSet<Gst2021SalesDatum> Gst2021SalesData { get; set; }

    public virtual DbSet<GstTb> GstTbs { get; set; }

    public virtual DbSet<GstexpDetail> GstexpDetails { get; set; }

    public virtual DbSet<GstpurchaseTemplate> GstpurchaseTemplates { get; set; }

    public virtual DbSet<GstsaleTemplate> GstsaleTemplates { get; set; }

    public virtual DbSet<HdfcFileDatum> HdfcFileData { get; set; }

    public virtual DbSet<HdfcReverseDatum> HdfcReverseData { get; set; }

    public virtual DbSet<HdfcpaymentDetail> HdfcpaymentDetails { get; set; }
    ...
    public virtual DbSet<Hsndatum> Hsndata { get; set; }

    public virtual DbSet<IbtaccountSync> IbtaccountSyncs { get; set; }

    public virtual DbSet<IbtdivisionUpdate> IbtdivisionUpdates { get; set; }
    ...
    public virtual DbSet<IndexUsageInfo> IndexUsageInfos { get; set; }

    public virtual DbSet<InoutSlsCo> InoutSlsCos { get; set; }

    public virtual DbSet<Inoutregister> Inoutregisters { get; set; }

    public virtual DbSet<InoutregisterNewOpeningDiffRemoved> InoutregisterNewOpeningDiffRemoveds { get; set; }
    ...
    public virtual DbSet<InstalledVersion> InstalledVersions { get; set; }

    public virtual DbSet<InventoryLedgerFormat> InventoryLedgerFormats { get; set; }

    public virtual DbSet<InventoryMailDatum> InventoryMailData { get; set; }
    ...
    public virtual DbSet<InventoryVoucherRemarksM> InventoryVoucherRemarksMs { get; set; }

    public virtual DbSet<InventorytransBoserver> InventorytransBoservers { get; set; }

    public virtual DbSet<InventorytransListBoserver> InventorytransListBoservers { get; set; }
    ...
    public virtual DbSet<ItemTaxStatusM> ItemTaxStatusMs { get; set; }
    ...
    public virtual DbSet<JdaListM> JdaListMs { get; set; }

    public virtual DbSet<Jdum> Jda { get; set; }

    public virtual DbSet<JobOrderResult> JobOrderResults { get; set; }

    public virtual DbSet<JobOrderResultsHdr> JobOrderResultsHdrs { get; set; }

    public virtual DbSet<JobRequestHdr> JobRequestHdrs { get; set; }

    public virtual DbSet<JobRequestList> JobRequestLists { get; set; }

    public virtual DbSet<JobRequestListExtn> JobRequestListExtns { get; set; }

    public virtual DbSet<KhammamVoucherHeader> KhammamVoucherHeaders { get; set; }

    public virtual DbSet<LastTbprocessed> LastTbprocesseds { get; set; }

    public virtual DbSet<LateCutoff> LateCutoffs { get; set; }

    public virtual DbSet<LeaveTypeM> LeaveTypeMs { get; set; }

    public virtual DbSet<LeaveUpdate> LeaveUpdates { get; set; }
    ...
    public virtual DbSet<LockMovingAverageProcess> LockMovingAverageProcesses { get; set; }

    public virtual DbSet<LockNewSoba> LockNewSobas { get; set; }

    public virtual DbSet<LockReleaseM> LockReleaseMs { get; set; }

    public virtual DbSet<MOpeningRate> MOpeningRates { get; set; }

    public virtual DbSet<MOpeningRatesOld> MOpeningRatesOlds { get; set; }

    public virtual DbSet<MVoucherDetail> MVoucherDetails { get; set; }

    public virtual DbSet<MVoucherHeader> MVoucherHeaders { get; set; }

    public virtual DbSet<MarCls2012> MarCls2012s { get; set; }

    public virtual DbSet<MdTurnoverMview> MdTurnoverMviews { get; set; }

    public virtual DbSet<MdclassificationM> MdclassificationMs { get; set; }

    public virtual DbSet<MdstateM> MdstateMs { get; set; }

    public virtual DbSet<MdsubGroupM> MdsubGroupMs { get; set; }

    public virtual DbSet<MdsubGroupMBk> MdsubGroupMBks { get; set; }

    public virtual DbSet<MedicalTran> MedicalTrans { get; set; }

    public virtual DbSet<Medicaltrans1516> Medicaltrans1516s { get; set; }

    public virtual DbSet<MedicaltransList> MedicaltransLists { get; set; }

    public virtual DbSet<MenusM> MenusMs { get; set; }

    public virtual DbSet<MfstateDetail> MfstateDetails { get; set; }

    public virtual DbSet<MigratedMovingAvg> MigratedMovingAvgs { get; set; }

    public virtual DbSet<MigratedMovingAvgSrn> MigratedMovingAvgSrns { get; set; }

    public virtual DbSet<MisRecosDatum> MisRecosData { get; set; }

    public virtual DbSet<MonthEndAccountPostingStatus> MonthEndAccountPostingStatuses { get; set; }

    public virtual DbSet<MonthEndAccountPostingStatusBackup> MonthEndAccountPostingStatusBackups { get; set; }

    public virtual DbSet<MonthEndAccountPostingStatusBackupTillJan2021> MonthEndAccountPostingStatusBackupTillJan2021s { get; set; }

    public virtual DbSet<MonthEndProcedureM> MonthEndProcedureMs { get; set; }

    public virtual DbSet<MonthEndProcessFlowHistory> MonthEndProcessFlowHistories { get; set; }

    public virtual DbSet<MonthEndProcessFlowM> MonthEndProcessFlowMs { get; set; }

    public virtual DbSet<MonthWiseReceiptIssueQtyOfStock> MonthWiseReceiptIssueQtyOfStocks { get; set; }

    public virtual DbSet<MonthWiseSale> MonthWiseSales { get; set; }
    ...
    public virtual DbSet<NegativeStock> NegativeStocks { get; set; }

    public virtual DbSet<NegativeStockCheck> NegativeStockChecks { get; set; }

    public virtual DbSet<Number> Numbers { get; set; }

    public virtual DbSet<O> Os { get; set; }

    public virtual DbSet<OldVoucherNoRefTableDelete> OldVoucherNoRefTableDeletes { get; set; }

    public virtual DbSet<OneTimeAddress> OneTimeAddresses { get; set; }

    public virtual DbSet<OpeningRate> OpeningRates { get; set; }

    public virtual DbSet<OpeningRate2021> OpeningRate2021s { get; set; }

    public virtual DbSet<OpeningRatesCipd> OpeningRatesCipds { get; set; }

    public virtual DbSet<OpeningRatesOld> OpeningRatesOlds { get; set; }

    public virtual DbSet<OpnVoucherDetail> OpnVoucherDetails { get; set; }

    public virtual DbSet<OpnVoucherHeader> OpnVoucherHeaders { get; set; }

    public virtual DbSet<OsAbove180> OsAbove180s { get; set; }
    ...
    public virtual DbSet<PartyCode> PartyCodes { get; set; }
    ...
    public virtual DbSet<PartyFreezeM> PartyFreezeMs { get; set; }

    public virtual DbSet<PartyKyc> PartyKycs { get; set; }

    public virtual DbSet<PartyM> PartyMs { get; set; }

    public virtual DbSet<PartyM908> PartyM908s { get; set; }

    public virtual DbSet<PartyMContactPersonPhoneNo> PartyMContactPersonPhoneNos { get; set; }
    ...
    public virtual DbSet<PartyWhatsapp> PartyWhatsapps { get; set; }
    ...
    public virtual DbSet<Pdfqry> Pdfqries { get; set; }

    public virtual DbSet<Pdlist> Pdlists { get; set; }

    public virtual DbSet<Pdm> Pdms { get; set; }

    public virtual DbSet<PendingPurchaseOrder> PendingPurchaseOrders { get; set; }
    ...
    public virtual DbSet<PlclassificationItemSubGroupMapping> PlclassificationItemSubGroupMappings { get; set; }

    public virtual DbSet<PlclassificationM> PlclassificationMs { get; set; }

    public virtual DbSet<PlitemSubGroup> PlitemSubGroups { get; set; }
    ...
    public virtual DbSet<PoindentExemptedItemM> PoindentExemptedItemMs { get; set; }

    public virtual DbSet<Poschedule> Poschedules { get; set; }

    public virtual DbSet<PostingError> PostingErrors { get; set; }

    public virtual DbSet<PostingErrorForConsignmentGrn> PostingErrorForConsignmentGrns { get; set; }

    public virtual DbSet<PpaEmail> PpaEmails { get; set; }
    ...
    public virtual DbSet<PreDefinedQuries160217backup> PreDefinedQuries160217backups { get; set; }

    public virtual DbSet<PreRate> PreRates { get; set; }

    public virtual DbSet<PredefinedQueriesBackUp> PredefinedQueriesBackUps { get; set; }
    ...
    public virtual DbSet<PriceDiscountControlMhistory> PriceDiscountControlMhistories { get; set; }
    ...
    public virtual DbSet<ProcessForPosting> ProcessForPostings { get; set; }
    ...
    public virtual DbSet<ProdAvgRate> ProdAvgRates { get; set; }

    public virtual DbSet<ProdSumTest> ProdSumTests { get; set; }

    public virtual DbSet<ProductPromotionAllDatum> ProductPromotionAllData { get; set; }
    ...
    public virtual DbSet<Productavgrate> Productavgrates { get; set; }
    ...
    public virtual DbSet<ProfitandLossHierachy> ProfitandLossHierachies { get; set; }
    ...
    public virtual DbSet<ProvisionalInoutRegister> ProvisionalInoutRegisters { get; set; }

    public virtual DbSet<ProvisionalSchemeCreditNote> ProvisionalSchemeCreditNotes { get; set; }

    public virtual DbSet<ProvisionalSchemeCreditNoteTemp> ProvisionalSchemeCreditNoteTemps { get; set; }

    public virtual DbSet<PurchaseDiscountCorrection> PurchaseDiscountCorrections { get; set; }
    ...
    public virtual DbSet<ROverHeadAnalysisOtherAccounts1> ROverHeadAnalysisOtherAccounts1s { get; set; }
    ...
    public virtual DbSet<RecOsMonthDatum> RecOsMonthData { get; set; }

    public virtual DbSet<RecTotalO> RecTotalOs { get; set; }

    public virtual DbSet<RecTotalOsBd> RecTotalOsBds { get; set; }

    public virtual DbSet<RecTotalOsDrAll> RecTotalOsDrAlls { get; set; }

    public virtual DbSet<RecTurnover> RecTurnovers { get; set; }

    public virtual DbSet<RegistrationMDelete> RegistrationMDeletes { get; set; }
    ...
    public virtual DbSet<ReportDataStateM> ReportDataStateMs { get; set; }
    ...
    public virtual DbSet<SalaryPostingFromExcelTemplate> SalaryPostingFromExcelTemplates { get; set; }

    public virtual DbSet<SalaryPostingTemplate> SalaryPostingTemplates { get; set; }

    public virtual DbSet<SalaryandFdposting> SalaryandFdpostings { get; set; }

    public virtual DbSet<SalarypostingAll> SalarypostingAlls { get; set; }

    public virtual DbSet<SalarypostingBackup> SalarypostingBackups { get; set; }

    public virtual DbSet<Salarypostingerror> Salarypostingerrors { get; set; }

    public virtual DbSet<SaleOrderMobile> SaleOrderMobiles { get; set; }

    public virtual DbSet<SalesDataAudit1920> SalesDataAudit1920s { get; set; }

    public virtual DbSet<SalesKn> SalesKns { get; set; }

    public virtual DbSet<SalesMi> SalesMis { get; set; }

    public virtual DbSet<SalesMis17182021> SalesMis17182021s { get; set; }

    public virtual DbSet<SalesMisAbm> SalesMisAbms { get; set; }

    public virtual DbSet<SalesMisBackup> SalesMisBackups { get; set; }

    public virtual DbSet<SalesOfficerHierachyChildM> SalesOfficerHierachyChildMs { get; set; }

    public virtual DbSet<SalesOfficerM> SalesOfficerMs { get; set; }

    public virtual DbSet<SalesOfficersExecutivesMappingM> SalesOfficersExecutivesMappingMs { get; set; }

    public virtual DbSet<SalesOfficersExecutivesMappingMSalesValue> SalesOfficersExecutivesMappingMSalesValues { get; set; }

    public virtual DbSet<SalesOfficersExecutivesMappingMSumofSalesValue> SalesOfficersExecutivesMappingMSumofSalesValues { get; set; }
    ...
    public virtual DbSet<SalesRegister2324> SalesRegister2324s { get; set; }

    public virtual DbSet<Schedule6GroupM> Schedule6GroupMs { get; set; }

    public virtual DbSet<ScheduleGroupM> ScheduleGroupMs { get; set; }

    public virtual DbSet<ScheduleM> ScheduleMs { get; set; }

    public virtual DbSet<SchedulePrintOrder> SchedulePrintOrders { get; set; }
    ...
    public virtual DbSet<ScmEmail> ScmEmails { get; set; }
    ...
    public virtual DbSet<SeedTargetItemLinkMapping> SeedTargetItemLinkMappings { get; set; }
    ...
    public virtual DbSet<ShiptoBranchM> ShiptoBranchMs { get; set; }

    public virtual DbSet<SingleInvoiceTradeDiscountExemptedM> SingleInvoiceTradeDiscountExemptedMs { get; set; }

    public virtual DbSet<SingleInvoiceTradeDiscountExemptedMbackup> SingleInvoiceTradeDiscountExemptedMbackups { get; set; }

    public virtual DbSet<SmsnewParty> SmsnewParties { get; set; }

    public virtual DbSet<SmsreceiptDatum> SmsreceiptData { get; set; }

    public virtual DbSet<SmssalesDatum> SmssalesData { get; set; }

    public virtual DbSet<SoPhone> SoPhones { get; set; }
    ...
    public virtual DbSet<Sotabill> Sotabills { get; set; }

    public virtual DbSet<SowingReportM> SowingReportMs { get; set; }

    public virtual DbSet<SpVoucherDetail> SpVoucherDetails { get; set; }

    public virtual DbSet<SpVoucherHeader> SpVoucherHeaders { get; set; }

    public virtual DbSet<StDecl> StDecls { get; set; }

    public virtual DbSet<StanesPesticidesDetailDelete> StanesPesticidesDetailDeletes { get; set; }

    public virtual DbSet<StanesSsisjob> StanesSsisjobs { get; set; }

    public virtual DbSet<StanesSsisjobsNew> StanesSsisjobsNews { get; set; }
    ...
    public virtual DbSet<StockLedgerWithRunningStockTemp> StockLedgerWithRunningStockTemps { get; set; }

    public virtual DbSet<StockLedgerWithRunningStockTemp2Status> StockLedgerWithRunningStockTemp2Statuses { get; set; }
    ...
    public virtual DbSet<SupplierWiseTdsper> SupplierWiseTdspers { get; set; }
    ...
    public virtual DbSet<TabIllPaymentRequestDatum> TabIllPaymentRequestData { get; set; }

    public virtual DbSet<TabIllRawData1> TabIllRawData1s { get; set; }

    public virtual DbSet<TabIllRawDatum> TabIllRawData { get; set; }

    public virtual DbSet<TabillApproval> TabillApprovals { get; set; }

    public virtual DbSet<TabillApproval08102024> TabillApproval08102024s { get; set; }

    public virtual DbSet<TabillApproved> TabillApproveds { get; set; }

    public virtual DbSet<TabillDeduction> TabillDeductions { get; set; }

    public virtual DbSet<TabillDetail> TabillDetails { get; set; }

    public virtual DbSet<TabillManualReceived> TabillManualReceiveds { get; set; }

    public virtual DbSet<TabillRawExcelDatum> TabillRawExcelData { get; set; }

    public virtual DbSet<TabillRequest> TabillRequests { get; set; }

    public virtual DbSet<TableCmrecordCount> TableCmrecordCounts { get; set; }

    public virtual DbSet<TableCommDetail> TableCommDetails { get; set; }

    public virtual DbSet<TaempSubM> TaempSubMs { get; set; }

    public virtual DbSet<TaempSubMNew> TaempSubMNews { get; set; }

    public virtual DbSet<Taemployee> Taemployees { get; set; }

    public virtual DbSet<TaemployeeHistory> TaemployeeHistories { get; set; }

    public virtual DbSet<TaemployeeM> TaemployeeMs { get; set; }

    public virtual DbSet<TaemployeeM1> TaemployeeM1s { get; set; }

    public virtual DbSet<TaemployeeMBk> TaemployeeMBks { get; set; }

    public virtual DbSet<TaemployeeMBk07072016> TaemployeeMBk07072016s { get; set; }

    public virtual DbSet<TaemployeeMBr> TaemployeeMBrs { get; set; }

    public virtual DbSet<TargetFieldSalesDet> TargetFieldSalesDets { get; set; }

    public virtual DbSet<TargetFixM> TargetFixMs { get; set; }

    public virtual DbSet<TargetGrpSegDvnLink> TargetGrpSegDvnLinks { get; set; }

    public virtual DbSet<TargetItemLinkMapping> TargetItemLinkMappings { get; set; }

    public virtual DbSet<TargetM> TargetMs { get; set; }

    public virtual DbSet<TargetMitemSubGroupMapping> TargetMitemSubGroupMappings { get; set; }

    public virtual DbSet<TargetSale> TargetSales { get; set; }

    public virtual DbSet<TargetSalesOverall> TargetSalesOveralls { get; set; }

    public virtual DbSet<TargetSalescum> TargetSalescums { get; set; }

    public virtual DbSet<TargetSoBrSt> TargetSoBrSts { get; set; }

    public virtual DbSet<TargetSowiseSalesDet> TargetSowiseSalesDets { get; set; }
    ...
    public virtual DbSet<TaxMcipd> TaxMcipds { get; set; }

    public virtual DbSet<TaxMcipdDetail> TaxMcipdDetails { get; set; }

    public virtual DbSet<TaxMdetail> TaxMdetails { get; set; }

    public virtual DbSet<TaxTypeM> TaxTypeMs { get; set; }

    public virtual DbSet<TaxboxM> TaxboxMs { get; set; }

    public virtual DbSet<TaxboxMdetail> TaxboxMdetails { get; set; }

    public virtual DbSet<TaxboxMheader> TaxboxMheaders { get; set; }

    public virtual DbSet<TaxboxMm> TaxboxMms { get; set; }

    public virtual DbSet<TbaccountGroupM> TbaccountGroupMs { get; set; }

    public virtual DbSet<TbaccountM> TbaccountMs { get; set; }

    public virtual DbSet<TbcontrolCodeM> TbcontrolCodeMs { get; set; }

    public virtual DbSet<TblAccount> TblAccounts { get; set; }

    public virtual DbSet<TblEmployeeAchievedInput> TblEmployeeAchievedInputs { get; set; }

    public virtual DbSet<TblEmployeeMonthlyTargetInput> TblEmployeeMonthlyTargetInputs { get; set; }

    public virtual DbSet<TblEmployeeYearlyTargetInput> TblEmployeeYearlyTargetInputs { get; set; }

    public virtual DbSet<Td> Tds { get; set; }

    public virtual DbSet<Temp> Temps { get; set; }

    public virtual DbSet<Temp194RcreditNoteForDebitNotePreparation> Temp194RcreditNoteForDebitNotePreparations { get; set; }

    public virtual DbSet<TempActiveParty> TempActiveParties { get; set; }

    public virtual DbSet<TempApprovedVoucherDetail> TempApprovedVoucherDetails { get; set; }

    public virtual DbSet<TempApprovedVoucherHeader> TempApprovedVoucherHeaders { get; set; }

    public virtual DbSet<TempApprovedVoucherHeaderExtn> TempApprovedVoucherHeaderExtns { get; set; }

    public virtual DbSet<TempBulkUpdatePartyCreditDay> TempBulkUpdatePartyCreditDays { get; set; }

    public virtual DbSet<TempBulkUpdatePartyCreditLimitM> TempBulkUpdatePartyCreditLimitMs { get; set; }

    public virtual DbSet<TempClosingStockDetail> TempClosingStockDetails { get; set; }

    public virtual DbSet<TempCollectionDetailsForBeforeSep> TempCollectionDetailsForBeforeSeps { get; set; }

    public virtual DbSet<TempCollectionDetailsForDebitNotePreparation> TempCollectionDetailsForDebitNotePreparations { get; set; }

    public virtual DbSet<TempCrDay> TempCrDays { get; set; }

    public virtual DbSet<TempCreditNoteForDebitNotePreparation> TempCreditNoteForDebitNotePreparations { get; set; }

    public virtual DbSet<TempDepDt> TempDepDts { get; set; }

    public virtual DbSet<TempDeposit> TempDeposits { get; set; }

    public virtual DbSet<TempDepositold> TempDepositolds { get; set; }

    public virtual DbSet<TempExportItem> TempExportItems { get; set; }

    public virtual DbSet<TempIbtalreadyInsertedVoucherDelete> TempIbtalreadyInsertedVoucherDeletes { get; set; }

    public virtual DbSet<TempItDelete> TempItDeletes { get; set; }

    public virtual DbSet<TempItem> TempItems { get; set; }

    public virtual DbSet<TempItlDelete> TempItlDeletes { get; set; }

    public virtual DbSet<TempNullDivisionVoucherHeader> TempNullDivisionVoucherHeaders { get; set; }

    public virtual DbSet<TempProvisionalSchemeCreditNote> TempProvisionalSchemeCreditNotes { get; set; }

    public virtual DbSet<TempProvisionalSchemeCreditNoteNew> TempProvisionalSchemeCreditNoteNews { get; set; }

    public virtual DbSet<TempPurchaseDetailsForDebitNotePreparation> TempPurchaseDetailsForDebitNotePreparations { get; set; }

    public virtual DbSet<TempPurchaseDetailsForDebitNotePreparationTest> TempPurchaseDetailsForDebitNotePreparationTests { get; set; }

    public virtual DbSet<TempROverheadServiceDivAllocation> TempROverheadServiceDivAllocations { get; set; }

    public virtual DbSet<TempReceivable> TempReceivables { get; set; }

    public virtual DbSet<TempReceivablesSummary> TempReceivablesSummaries { get; set; }

    public virtual DbSet<TempRfcsalesDatum> TempRfcsalesData { get; set; }

    public virtual DbSet<TempSowiseSale> TempSowiseSales { get; set; }

    public virtual DbSet<TempTaxM> TempTaxMs { get; set; }

    public virtual DbSet<TempTaxMaster> TempTaxMasters { get; set; }

    public virtual DbSet<TempTaxMdetail> TempTaxMdetails { get; set; }

    public virtual DbSet<TempVoucher> TempVouchers { get; set; }

    public virtual DbSet<TempVoucherCreation> TempVoucherCreations { get; set; }

    public virtual DbSet<TempVoucherHeader> TempVoucherHeaders { get; set; }

    public virtual DbSet<Tempopb> Tempopbs { get; set; }

    public virtual DbSet<TestMethodList> TestMethodLists { get; set; }

    public virtual DbSet<TestMethodM> TestMethodMs { get; set; }

    public virtual DbSet<Tjposting> Tjpostings { get; set; }

    public virtual DbSet<TmpClosingdaywise> TmpClosingdaywises { get; set; }

    public virtual DbSet<TmpVd> TmpVds { get; set; }

    public virtual DbSet<Tmpclstk> Tmpclstks { get; set; }

    public virtual DbSet<Tmpmvg> Tmpmvgs { get; set; }

    public virtual DbSet<To20132014> To20132014s { get; set; }

    public virtual DbSet<To20142015> To20142015s { get; set; }

    public virtual DbSet<To20152016> To20152016s { get; set; }

    public virtual DbSet<To20162017> To20162017s { get; set; }

    public virtual DbSet<To20172018> To20172018s { get; set; }
    ...
    public virtual DbSet<Transtest> Transtests { get; set; }

    public virtual DbSet<Treceivable> Treceivables { get; set; }

    public virtual DbSet<Tslm> Tslms { get; set; }

    public virtual DbSet<TtAsig19062024401> TtAsig19062024401s { get; set; }

    public virtual DbSet<TtAsig40119062024Ex> TtAsig40119062024Exes { get; set; }
    ...
    public virtual DbSet<TurnoverMdLinksM> TurnoverMdLinksMs { get; set; }
    ...
    public virtual DbSet<UserMasterDelete> UserMasterDeletes { get; set; }

    public virtual DbSet<UserRight> UserRights { get; set; }

    public virtual DbSet<UserRightsWebApplicationDelete> UserRightsWebApplicationDeletes { get; set; }
    ...
    public virtual DbSet<Vasummary> Vasummaries { get; set; }
    ...
    public virtual DbSet<VersionMHistoryBk> VersionMHistoryBks { get; set; }

    public virtual DbSet<VersionUpdate> VersionUpdates { get; set; }

    public virtual DbSet<View1> View1s { get; set; }

    public virtual DbSet<VocuherDetailPaise> VocuherDetailPaises { get; set; }

    public virtual DbSet<VoucherCreationTemplate> VoucherCreationTemplates { get; set; }
    ...
    public virtual DbSet<VoucherMatchlinknew> VoucherMatchlinknews { get; set; }

    public virtual DbSet<VoucherMatchnew> VoucherMatchnews { get; set; }

    public virtual DbSet<Voucherchecktempforssi> Voucherchecktempforssis { get; set; }

    public virtual DbSet<Voucherentryspeed> Voucherentryspeeds { get; set; }

    public virtual DbSet<Vouchermatchpaiseupd> Vouchermatchpaiseupds { get; set; }
    ...
    public virtual DbSet<VwBsschedule> VwBsschedules { get; set; }
    ...
    public virtual DbSet<VwControlCodeM> VwControlCodeMs { get; set; }
    ...
    public virtual DbSet<VwDetailsOfStockTransferIssueforFreight> VwDetailsOfStockTransferIssueforFreights { get; set; }

    public virtual DbSet<VwDetailsOfStockTransferRecdGst> VwDetailsOfStockTransferRecdGsts { get; set; }

    public virtual DbSet<VwDetailsOfStockTransferReceived> VwDetailsOfStockTransferReceiveds { get; set; }

    public virtual DbSet<VwDetailsOfStockTransferReceivedForFreight> VwDetailsOfStockTransferReceivedForFreights { get; set; }
    ...
    public virtual DbSet<VwDetailsofSalesReturn1> VwDetailsofSalesReturn1s { get; set; }

    public virtual DbSet<VwDetailsofSalesRtnGst> VwDetailsofSalesRtnGsts { get; set; }
    ...
    public virtual DbSet<VwInventoryLookupGrn> VwInventoryLookupGrns { get; set; }
    ...
    public virtual DbSet<VwItemRate30062017> VwItemRate30062017s { get; set; }
    ...
    public virtual DbSet<VwLiftDetailsForSchemeWithType> VwLiftDetailsForSchemeWithTypes { get; set; }

    public virtual DbSet<VwOsStmt> VwOsStmts { get; set; }

    public virtual DbSet<VwParentBranch> VwParentBranches { get; set; }

    public virtual DbSet<VwPartyCode> VwPartyCodes { get; set; }
    ...
    public virtual DbSet<VwPurchaseInvoiceforViewing> VwPurchaseInvoiceforViewings { get; set; }
    ...
    public virtual DbSet<VwSchemeAppliedForWithType> VwSchemeAppliedForWithTypes { get; set; }
    ...
    public virtual DbSet<VwSelectPurchaseInvoiceInventoryTransListUid1> VwSelectPurchaseInvoiceInventoryTransListUid1s { get; set; }
    ...
    public virtual DbSet<VwStockTransferIssueDet> VwStockTransferIssueDets { get; set; }
    ...
    public virtual DbSet<VwTabillApproval> VwTabillApprovals { get; set; }
    ...
    public virtual DbSet<VwVoucherdetail1> VwVoucherdetails { get; set; }
    ...
    public virtual DbSet<ZeroTochek> ZeroTocheks { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=Mainserver_Aws;Database=CommonDB_Test;User ID=ssis_user;Password=ssis+se;TrustServerCertificate=True;MultipleActiveResultSets=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AccountGroupM>(entity =>
        {
            ...
            entity.HasIndex(e => e.IsActive, "IX_Isactive_AccountUID").HasFillFactor(90);
        ...
        modelBuilder.Entity<AccountM>(entity =>
        {
            ...
            entity.HasIndex(e => e.IsGroup, "IX_AccountM_IsGroup").HasFillFactor(90);

            entity.HasIndex(e => new { e.IsGroup, e.IsActive }, "IX_IsGrp_IsActive_AccountCode").HasFillFactor(90);

            entity.HasIndex(e => new { e.IsActive, e.IsGroup, e.AccountDescription }, "IX_IsGrp_Isactive").HasFillFactor(90);
        ...
        modelBuilder.Entity<AccountMextn>(entity =>
        {
            entity.HasKey(e => e.AccountUid).HasFillFactor(90);

            entity.Property(e => e.AccountUid).ValueGeneratedNever();

            entity.HasOne(d => d.AccountU).WithOne(p => p.AccountMextn)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AccountMExtn_AccountM");

            entity.HasOne(d => d.CrScheduleU).WithMany(p => p.AccountMextnCrScheduleUs)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AccountMExtn_ScheduleM1");

            entity.HasOne(d => d.DrScheduleU).WithMany(p => p.AccountMextnDrScheduleUs)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AccountMExtn_ScheduleM");
        });

        modelBuilder.Entity<AccountmBackupUnused>(entity =>
        {
            entity.Property(e => e.IsBranch).IsFixedLength();
        });

        modelBuilder.Entity<ActiveAreaSoMappingAppDatum>(entity =>
        {
            entity.Property(e => e.SegmentCode).IsFixedLength();
        });

        modelBuilder.Entity<ActualStatusM>(entity =>
        {
            entity.HasKey(e => e.ActualStatusUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.AffectedAccountTypesUid).HasFillFactor(90);

            entity.Property(e => e.AffectedAccountTypesUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<AlertMessageM>(entity =>
        {
            entity.HasKey(e => e.AlertMessageUid).HasFillFactor(90);

            entity.Property(e => e.AlertMessageUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<AlertReceiptM>(entity =>
        {
            entity.HasKey(e => e.AlertReceiptUid).HasFillFactor(90);

            entity.Property(e => e.AlertReceiptUid).ValueGeneratedNever();
            entity.Property(e => e.Type).IsFixedLength();
        });

        modelBuilder.Entity<AlertReceiptMbackup>(entity =>
        {
            entity.Property(e => e.Type).IsFixedLength();
        });

        modelBuilder.Entity<AlertReceiptMbackupforMvg>(entity =>
        {
            entity.Property(e => e.Type).IsFixedLength();
        });
        ...
        {
            entity.HasKey(e => e.AnnouncementUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<ApprovedVoucherDetail>(entity =>
        {
            ...
            entity.HasIndex(e => e.ApprovedVoucherDetailUid, "IX_ApprovedVoucherHeaderUID").HasFillFactor(90);
        ...
        modelBuilder.Entity<ApprovedVoucherHeader>(entity =>
        {
            ...
            entity.HasIndex(e => e.BranchUid, "IX_BRanchUID_approvedHeaderUID").HasFillFactor(90);
        ...
        modelBuilder.Entity<AreaSoitemGroup>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.DivisionPrincipleUid, e.AreaSouid, e.EffectiveFromDate }, "IX_Area_DivisionPrinciple").HasFillFactor(90);
        ...
        modelBuilder.Entity<BalanceSheetScheduleDetail>(entity =>
        {
            entity.ToView("BalanceSheetScheduleDetails");
        });
        ...
        modelBuilder.Entity<BankM>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.AccountCode, e.AccountNo, e.BankName, e.BankId }, "IX_BankM")
                .IsUnique()
                .HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.BcerequestLevelPerUid).HasFillFactor(90);
        ...
        {
            entity.Property(e => e.BdlistUid).ValueGeneratedNever();

            entity.HasOne(d => d.DivisionPrincipleU).WithMany(p => p.Bdlists)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_BDList_DivisionPrincipleM");

            entity.HasOne(d => d.PartyU).WithMany(p => p.Bdlists)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_BDList_PartyM1");
        });

        modelBuilder.Entity<BdlistHistory>(entity =>
        {
            entity.Property(e => e.Bdyear).IsFixedLength();
        });

        modelBuilder.Entity<Bdstatus>(entity =>
        {
            entity.HasKey(e => e.BdstatusUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.BillPassingUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.BrMgrBankDebitDetailUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.BrCrNoteRegRequestUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<BranchImprest>(entity =>
        {
            ...
            entity.HasOne(d => d.AccountU).WithMany(p => p.BranchImprests).HasConstraintName("FK_BranchImprest_AccountM");
        ...
        modelBuilder.Entity<BranchLinkedServerM>(entity =>
        {
            entity.Property(e => e.BranchDbname).IsFixedLength();
            entity.Property(e => e.BranchLinkServerName).IsFixedLength();
            entity.Property(e => e.SyncDbname).IsFixedLength();
            entity.Property(e => e.SyncLinkServerName).IsFixedLength();
        });
        ...
        modelBuilder.Entity<BranchPotoReceive>(entity =>
        {
            ...
            entity.HasIndex(e => e.ReceivingBranchUid, "IX_ReceivingBR_CDate_MDate").HasFillFactor(90);
        ...
        modelBuilder.Entity<BranchTransferReceipt>(entity =>
        {
            ...
            entity.HasIndex(e => e.IsActive, "IX_Isactive").HasFillFactor(90);

            entity.HasIndex(e => e.IssueBranchUid, "IX_IssueBranchUID").HasFillFactor(90);
        ...
        modelBuilder.Entity<BranchTransferReceiptFromBranch>(entity =>
        {
            ...
            entity.HasIndex(e => e.IssueBranchUid, "IX_BranchTransferReceiptFromBranch_IssueBranchUID_Includes").HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.CashFlowGroupUid).HasFillFactor(90);

            entity.Property(e => e.CashFlowGroupUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<ChangeFlag>(entity =>
        {
            entity.HasKey(e => new { e.TableName, e.PartyUid }).HasName("PK__ChangeFl__7F63F4F48BF94CFA");
        });

        modelBuilder.Entity<ChemicalM>(entity =>
        {
            entity.HasKey(e => e.ChemicalUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<ChequeBounceHistory>(entity =>
        {
            ...
            entity.HasIndex(e => e.VoucherMatchCruid, "<IX_voucherMatchUID,>").HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.ChequeLodgementDetailUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.ChequeBounceDetailUid).HasFillFactor(90);

            entity.Property(e => e.ChequeBounceDetailUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<ClosingQtyTemp>(entity =>
        {
            entity.ToView("ClosingQtyTemp");
        });

        modelBuilder.Entity<ClosingStockMovingAvg>(entity =>
        {
            entity.ToView("ClosingStockMovingAvg");
        });

        modelBuilder.Entity<ClosingStockStatusGst>(entity =>
        {
            entity.Property(e => e.DecStock).IsFixedLength();
        });

        modelBuilder.Entity<CommissionM>(entity =>
        {
            entity.HasKey(e => e.CommissionUid).HasFillFactor(90);

            entity.Property(e => e.CommissionUid).ValueGeneratedNever();

            entity.HasOne(d => d.DivisionU).WithMany(p => p.CommissionMs)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CommissionM_DivisionM");
        });

        modelBuilder.Entity<CommissionMappingBranch>(entity =>
        {
            entity.Property(e => e.CommissionMappingBranchUid).ValueGeneratedNever();
            entity.Property(e => e.BranchUid).HasDefaultValueSql("(newid())");

            entity.HasOne(d => d.BranchU).WithMany(p => p.CommissionMappingBranches)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CommissionMappingBranch_BranchM");

            entity.HasOne(d => d.CommissionU).WithMany(p => p.CommissionMappingBranches)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CommissionMappingBranch_CommissionM");
        });

        modelBuilder.Entity<CommissionQtyLift>(entity =>
        {
            entity.HasKey(e => e.CommissionQtyLiftUid).HasFillFactor(90);

            entity.Property(e => e.CommissionQtyLiftUid).ValueGeneratedNever();

            entity.HasOne(d => d.CommissionU).WithMany(p => p.CommissionQtyLifts)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CommissionQtyLift_CommissionM");
        });

        modelBuilder.Entity<CommissionTargetLink>(entity =>
        {
            entity.HasKey(e => e.CommissionTargetLinkUid)
                .HasName("PK_CommissionItemLink")
                .HasFillFactor(90);

            entity.Property(e => e.CommissionTargetLinkUid).ValueGeneratedNever();

            entity.HasOne(d => d.CommissionU).WithMany(p => p.CommissionTargetLinks)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CommissionItemLink_CommissionM");

            entity.HasOne(d => d.TargetU).WithMany(p => p.CommissionTargetLinks)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CommissionTargetLink_TargetM");
        });

        modelBuilder.Entity<CommissionValueLift>(entity =>
        {
            entity.HasKey(e => e.CommissionValueLiftUid).HasFillFactor(90);

            entity.Property(e => e.CommissionValueLiftUid).ValueGeneratedNever();

            entity.HasOne(d => d.CommissionU).WithMany(p => p.CommissionValueLifts)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CommissionValueLift_CommissionM");
        });

        modelBuilder.Entity<CommodityCodeM>(entity =>
        {
            entity.HasKey(e => e.CommodityUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.CompanyUid).HasFillFactor(90);

            entity.Property(e => e.CompanyUid).ValueGeneratedNever();
            entity.Property(e => e.CompanyCode).IsFixedLength();
        });

        modelBuilder.Entity<ConGrowersSalesDatum>(entity =>
        {
            entity.Property(e => e.AreaCode).IsFixedLength();
            entity.Property(e => e.AreaName).IsFixedLength();
            entity.Property(e => e.BatchNo).IsFixedLength();
            entity.Property(e => e.EntityNumber).IsFixedLength();
            entity.Property(e => e.FrieghtPaymentType).IsFixedLength();
            entity.Property(e => e.InvoiceNumber).IsFixedLength();
            entity.Property(e => e.PrincipleName).IsFixedLength();
            entity.Property(e => e.SalesType).IsFixedLength();
            entity.Property(e => e.SeedCategory).IsFixedLength();
            entity.Property(e => e.SeedType).IsFixedLength();
            entity.Property(e => e.SeedVariety).IsFixedLength();
            entity.Property(e => e.TransactionTypeDesc).IsFixedLength();
            entity.Property(e => e.ZoneCode).IsFixedLength();
            entity.Property(e => e.ZoneName).IsFixedLength();
        });

        modelBuilder.Entity<ConSalesOsColl>(entity =>
        {
            entity.Property(e => e.ItemSegmentCode).IsFixedLength();
        });

        modelBuilder.Entity<ConSalesOsCollParty>(entity =>
        {
            entity.Property(e => e.ItemSegmentCode).IsFixedLength();
        });
        ...
        modelBuilder.Entity<ConsignmentGrnstatus>(entity =>
        {
            entity.HasKey(e => e.ConsignmentGrnstatusUid).HasFillFactor(90);

            entity.Property(e => e.ConsignmentGrnstatusUid).ValueGeneratedNever();
        });
        ...
        {
            entity.HasKey(e => e.Cmcsuid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.CmsbookUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<ControlCodeScheduleM>(entity =>
        {
            entity.HasKey(e => e.ControlCodeScheduleUid).HasFillFactor(90);

            entity.Property(e => e.ControlCodeScheduleUid).ValueGeneratedNever();

            entity.HasOne(d => d.AccountU).WithMany(p => p.ControlCodeScheduleMs)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ControlCodeScheduleM_AccountM");

            entity.HasOne(d => d.CrScheduleU).WithMany(p => p.ControlCodeScheduleMCrScheduleUs)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ControlCodeScheduleM_ScheduleM1");

            entity.HasOne(d => d.DrScheduleU).WithMany(p => p.ControlCodeScheduleMDrScheduleUs)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ControlCodeScheduleM_ScheduleM");
        });

        modelBuilder.Entity<CosaepostingStatus>(entity =>
        {
            entity.HasKey(e => e.CosaestatusUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.CountryItemRateUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.CreditDaysMuid).HasFillFactor(90);

            entity.HasIndex(e => new { e.DivisionUid, e.DivisionPrincipleUid }, "UK_CreditDaysM").HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.CurrencyExChangeUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.CurrencyUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<DealerAsset>(entity =>
        {
            ...
            entity.ToTable("DealerAsset", tb =>
                {
                    tb.HasTrigger("RequestDealerAsset_Tr");
                    tb.HasTrigger("TI_AfterInsertDealerAsset");
                    tb.HasTrigger("TI_AfterUpdateDealerAsset");
                });
        ...
        modelBuilder.Entity<DealerBankDetail>(entity =>
        {
            ...
            entity.ToTable(tb =>
                {
                    tb.HasTrigger("BankDeails");
                    tb.HasTrigger("RequestDealerBankDetails_Tr");
                    tb.HasTrigger("TI_AfterInsertDealerBankDetails");
                    tb.HasTrigger("TI_AfterUpdateDealerBankDetails");
                });
        ...
        {
            entity.HasKey(e => e.DealerCategoryUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.DepartmentUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.DepartmentalDivisionUid).HasFillFactor(90);

            entity.Property(e => e.DepartmentalDivisionUid).HasDefaultValueSql("(newid())");
        });
        ...
        modelBuilder.Entity<DepreciationM>(entity =>
        {
            entity.ToTable("DepreciationM", tb => tb.HasTrigger("TI_DepreciationMGenNo"));

            entity.Property(e => e.DepreciationUid).ValueGeneratedNever();
        });
        ...
        {
            entity.HasKey(e => e.Discount4ControlMuid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.DiscountMappingCountryUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.DiscountMappingDealerCategoryUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.DiscountPaymentMadeUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<DiscountPercentageallowed>(entity =>
        {
            ...
            entity.ToTable("DiscountPercentageallowed", tb => tb.HasTrigger("Trg_DiscountPercentageallowed"));
        ...
        {
            entity.HasKey(e => e.DiscountTypeUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.DistanceChartUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.DivisionGroupMuid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.DivisionUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.DivisionPrincipleUid).HasFillFactor(90);

            entity.HasIndex(e => e.PrincipleCode, "UK_DivisionPrincipleM")
                .IsUnique()
                .HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.DrCrCodeSelectUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.DrcrcodeSelectLinkUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.EdChargesUid).HasFillFactor(90);

            entity.HasIndex(e => new { e.BranchUid, e.ItemUid }, "UQ_EDCharges_BranchUID_ItemUID")
                .IsUnique()
                .HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.EdmasterUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<Edposting>(entity =>
        {
            entity.Property(e => e.Id).ValueGeneratedOnAdd();
        });
        ...
        {
            entity.HasIndex(e => new { e.Itemcode, e.BranchCode }, "IX_EDSQtyCalculationTable1").HasFillFactor(90);
        });
        ...
        {
            entity.HasKey(e => e.EjvacknowledgeUpdationUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.EjvchallanUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.EjvvoucherUpdationUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.EnquiryMuid).HasFillFactor(90);
        ...
        modelBuilder.Entity<FassetClassM>(entity =>
        {
            entity.HasKey(e => e.FassetClassUid).HasFillFactor(90);

            entity.Property(e => e.FassetClassUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<FassetGroupM>(entity =>
        {
            entity.HasKey(e => e.FassetGroupUid).HasFillFactor(90);

            entity.ToTable("FAssetGroupM", tb => tb.HasTrigger("TI_FAssetGroupMGroupCode"));

            entity.Property(e => e.FassetGroupUid).ValueGeneratedNever();

            entity.HasOne(d => d.FassetClassU).WithMany(p => p.FassetGroupMs)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FAssetGroupM_FAssetClassM");
        });

        modelBuilder.Entity<FassetItemM>(entity =>
        {
            entity.HasKey(e => e.FassetItemUid).HasFillFactor(90);

            entity.ToTable("FAssetItemM", tb => tb.HasTrigger("TI_FAssetItemMFAssetItemCode"));

            entity.Property(e => e.FassetItemUid).ValueGeneratedNever();
            entity.Property(e => e.Abcclass).IsFixedLength();

            entity.HasOne(d => d.FassetSegmentU).WithMany(p => p.FassetItemMs)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FAssetItemM_FAssetSegmentM");
        });

        modelBuilder.Entity<FassetLocationTransfer>(entity =>
        {
            entity.Property(e => e.FassetLocationTransferUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<FassetSegmentM>(entity =>
        {
            entity.HasKey(e => e.FassetSegmentUid).HasFillFactor(90);

            entity.ToTable("FAssetSegmentM", tb => tb.HasTrigger("TI_FAssetSegmentMGroupCode"));

            entity.Property(e => e.FassetSegmentUid).ValueGeneratedNever();

            entity.HasOne(d => d.FassetSubGroupU).WithMany(p => p.FassetSegmentMs)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FAssetSegmentM_FAssetSubGroupM");
        });

        modelBuilder.Entity<FassetSubGroupM>(entity =>
        {
            entity.HasKey(e => e.FassetSubGroupUid).HasFillFactor(90);

            entity.ToTable("FAssetSubGroupM", tb => tb.HasTrigger("TI_FAssetSubGroupMSubGroupCode"));

            entity.Property(e => e.FassetSubGroupUid).ValueGeneratedNever();

            entity.HasOne(d => d.FassetGroupU).WithMany(p => p.FassetSubGroupMs)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FAssetSubGroupM_FAssetGroupM");
        });

        modelBuilder.Entity<FassetTransDetail>(entity =>
        {
            entity.HasKey(e => e.FassetTransDetailUid).HasFillFactor(90);

            entity.ToTable("FAssetTransDetail", tb =>
                {
                    tb.HasTrigger("TI_FAssetTransDetailFAssetSerialNo");
                    tb.HasTrigger("TI_FAssetTransDetailValidatePutIntoUseDate");
                });

            entity.Property(e => e.FassetTransDetailUid).ValueGeneratedNever();

            entity.HasOne(d => d.FassetSegmentU).WithMany(p => p.FassetTransDetails)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FAssetTransDetail_FAssetSegmentM");

            entity.HasOne(d => d.FassetTransHeaderU).WithMany(p => p.FassetTransDetails)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FAssetTransDetail_FAssetTransHeader");
        });

        modelBuilder.Entity<FassetTransDetailExtn>(entity =>
        {
            entity.Property(e => e.FassetTransDetailUid).ValueGeneratedNever();

            entity.HasOne(d => d.FassetTransDetailU).WithOne(p => p.FassetTransDetailExtn)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FAssetTransDetailExtn_FAssetTransDetail");
        });

        modelBuilder.Entity<FassetTransHeader>(entity =>
        {
            entity.HasKey(e => e.FassetTransHeaderUid).HasFillFactor(90);

            entity.ToTable("FAssetTransHeader", tb =>
                {
                    tb.HasTrigger("TI_FAssetTransHeaderTransNo");
                    tb.HasTrigger("TI_Validate_FAssetTransHeader_SupplierInvoiceNo");
                });

            entity.Property(e => e.FassetTransHeaderUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<FekycmasterM>(entity =>
        {
            entity.HasKey(e => e.ReqEmpUid).HasName("PK_Kyc_Master");
        ...
        {
            entity.HasKey(e => e.FinancialYearUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.FollowUpDetailUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.FormFentryUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.FreeItemMuid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.FreeItemQtyUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.FreeTransLinkUid).HasFillFactor(90);
        });

        modelBuilder.Entity<FreightChargesM>(entity =>
        {
            entity.HasKey(e => e.FreightChargesUid).HasFillFactor(90);

            entity.HasIndex(e => new { e.BranchUid, e.ItemUid }, "UQ_FreightChargesM_BranchUID_ItemUID")
                .IsUnique()
                .HasFillFactor(90);
        ...
        modelBuilder.Entity<FreightHdr>(entity =>
        {
            entity.ToTable("FreightHdr", tb => tb.HasTrigger("TI_FreightHdrDocNo"));

            entity.Property(e => e.FreightHdrUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<FreightList>(entity =>
        {
            entity.Property(e => e.FreightListUid).ValueGeneratedNever();

            entity.HasOne(d => d.FreightHdrU).WithMany(p => p.FreightLists)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_FreightList_FreightHdr");
        });

        modelBuilder.Entity<FreightListExtn>(entity =>
        {
            entity.Property(e => e.FreightListExtnUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<FrieghtPaymentTypeM>(entity =>
        {
            entity.HasKey(e => e.FrieghtPaymentTypeUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<Gitcorrection1>(entity =>
        {
            entity.ToView("GITCorrection");
        });

        modelBuilder.Entity<GracePeriodForBackDaysEntry>(entity =>
        {
            entity.HasKey(e => e.GraceperiodforbackdaysUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.GrnamendmentUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.GrncashPurchaseUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.GrnoutsourceMappingUid).HasFillFactor(90);
        ...
        {
            entity.HasIndex(e => e.GrossMarginEdvatMappingMuid, "PK_GrossMargin_EDVatMappingM")
                .IsUnique()
                .IsClustered()
                .HasFillFactor(90);
        ...
        modelBuilder.Entity<HdfcpaymentDetail>(entity =>
        {
            entity.Property(e => e.HdfcpaymentUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<HelpM>(entity =>
        {
            entity.HasKey(e => e.HelpMuid).HasFillFactor(90);
        ...
        modelBuilder.Entity<Hoapprovedatum>(entity =>
        {
            ...
            entity.ToTable("HOApprovedata", tb => tb.HasTrigger("TI_ChectSalesReturnApprovedQty"));
        ...
        modelBuilder.Entity<Hsndatum>(entity =>
        {
        ...
        modelBuilder.Entity<InOutRegisterMfNew>(entity =>
        {
            ...
            entity.ToTable("InOutRegisterMF_New", tb => tb.HasTrigger("Trg_CalculateMovingAvg_MF"));
        ...
        {
            entity.HasKey(e => e.RowUid).HasFillFactor(90);

            entity.ToTable("InOutRegister_New", tb => tb.HasTrigger("Trg_CalculateMovingAvg"));

            entity.HasIndex(e => new { e.BranchUid, e.ItemUid, e.Sno }, "IX_BRItem").HasFillFactor(90);

            entity.HasIndex(e => new { e.StockMonth, e.StockYear }, "IX_INoutRegister_New_StockMnthYr").HasFillFactor(90);

            entity.HasIndex(e => new { e.BranchUid, e.ItemUid, e.TransactionType, e.Sno }, "IX_InOutRegister_New_BranchUID_ITemUID_TransactionType_SNo").HasFillFactor(90);

            entity.HasIndex(e => new { e.InventoryTransUid, e.ItemUid }, "IX_InOutRegister_New_InventoryTransUID_ItemUID").HasFillFactor(90);

            entity.HasIndex(e => e.InventoryTransUid, "IX_InOutRegister_New_Inventorytrans").HasFillFactor(90);

            entity.HasIndex(e => e.ItemUid, "IX_InOutRegister_New_ItemUID").HasFillFactor(90);

            entity.HasIndex(e => e.ItemUid, "IX_InOutRegister_New_ItemUID_Includes").HasFillFactor(90);

            entity.HasIndex(e => e.InventoryTransListUid, "IX_InOutRegister_New_inventorytranslist").HasFillFactor(90);

            entity.HasIndex(e => new { e.TransactionTypeCode, e.DocDate }, "IX_TTCDOCNo").HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.IndexCommandId).HasFillFactor(90);
        });

        modelBuilder.Entity<IndexUsageInfo>(entity =>
        {
            entity.ToView("Index_Usage_Info");

            entity.Property(e => e.TypeDesc).UseCollation("Latin1_General_CI_AS_KS_WS");
        });

        modelBuilder.Entity<InoutSlsCo>(entity =>
        {
            entity.Property(e => e.Remarks).IsFixedLength();
            entity.Property(e => e.Sno).ValueGeneratedOnAdd();
        });
        ...
        {
            entity.ToView("inoutregister");

            entity.Property(e => e.Remark).IsFixedLength();
        });

        modelBuilder.Entity<InoutregisterNewOpeningDiffRemoved>(entity =>
        {
            entity.Property(e => e.Remarks).IsFixedLength();
            entity.Property(e => e.Sno).ValueGeneratedOnAdd();
        });
        ...
        modelBuilder.Entity<InventoryLedgerFormat>(entity =>
        {
            entity.ToView("InventoryLedgerFormat");
        });

        modelBuilder.Entity<InventoryMailDatum>(entity =>
        {
            entity.Property(e => e.InventoryMailUid).ValueGeneratedNever();
        });
            ...
            entity.ToTable(tb =>
                {
                    ...
                    tb.HasTrigger("TI_SMSSalesData");
                    tb.HasTrigger("TI_SMSSalesData_update");
                    tb.HasTrigger("TI_Validate_InventoryTrans_DocNo");
                });

            entity.HasIndex(e => new { e.BranchUid, e.DivisionUid }, "IX_BR_DI").HasFillFactor(90);

            entity.HasIndex(e => e.BranchUid, "IX_Br").HasFillFactor(90);

            entity.HasIndex(e => e.IsActive, "IX_Isactive").HasFillFactor(90);

            entity.HasIndex(e => new { e.TransactiontypesUid, e.DocDate }, "IX_Transaction_Type").HasFillFactor(90);

            entity.HasIndex(e => e.InventoryTransUid, "IX_inventorytransUID_Docno_Date").HasFillFactor(90);

            entity.HasIndex(e => new { e.DocDate, e.DivisionUid, e.BranchUid, e.DocNo }, "Inv_DateDiv").HasFillFactor(90);
        ...
        modelBuilder.Entity<InventoryTransList>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.InventoryTransUid, e.IsActive }, "IX_Isactive_Itemuid").HasFillFactor(90);

            entity.HasIndex(e => e.IsActive, "IX_Isactive_invetransuid_itemuid").HasFillFactor(90);

            entity.HasIndex(e => e.ItemUid, "IX_ItemLink").HasFillFactor(90);

            entity.HasIndex(e => e.SalesReturnInvTransUid, "IX_SalesReturnInvTransUID_Invtrasnuid").HasFillFactor(90);

            entity.HasIndex(e => new { e.InventoryTransListUid, e.ItemUid }, "IX_inventory_item").HasFillFactor(90);
        ...
        {
            entity.HasKey(e => new { e.BranchUid, e.TransactiontypesUid, e.FinYr, e.DivisionUid }).HasFillFactor(90);

            entity.ToTable(tb => tb.HasTrigger("TR_InventoryTransRequestSlNos"));
        });

        modelBuilder.Entity<InventoryVoucherRemarksM>(entity =>
        {
            entity.HasKey(e => e.RowUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.IssueReportingUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.ItemCategoryUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => new { e.DivisionUid, e.ItemSegmentUid, e.ItemCategoryUid }).HasFillFactor(90);
        });
        ...
        {
            entity.HasKey(e => e.ItemInterestedUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<ItemM>(entity =>
        {
            ...
            entity.HasIndex(e => e.IsEd, "IX_ItemMISED").HasFillFactor(90);

            entity.HasIndex(e => e.ItemCode, "IX_item_master_M").HasFillFactor(90);

            entity.HasIndex(e => e.ItemUid, "NCLIX_ItemM_ItemUID").HasFillFactor(90);
        ...
        modelBuilder.Entity<ItemPrincipleSerialNoLink>(entity =>
        {
            ...
            entity.ToTable("ItemPrincipleSerialNoLink", tb => tb.HasTrigger("Trg_ToStopDeletion_ItemPrincipleSerialNoLink"));
        ...
        modelBuilder.Entity<ItemRate>(entity =>
        {
            ...
            entity.HasIndex(e => e.ItemRateUid, "NCLIX_ItemRate_ItemRateUID").HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.ItemRateTypeUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.ItemRequestRejectionUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => new { e.BranchUid, e.FinYear }).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.ItemStatusUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.ItemSupplierLinkUid).HasFillFactor(90);

            entity.ToTable("ItemSupplierLink", tb => tb.HasTrigger("TI_ItemSupplierLinkUID"));

            entity.HasIndex(e => new { e.PartyUid, e.ItemUid }, "UK_ItemSupplierLink").HasFillFactor(90);
        ...
        modelBuilder.Entity<ItemTaxStatusM>(entity =>
        {
            entity.HasKey(e => e.ItemTaxStatusUid).HasFillFactor(90);

            entity.Property(e => e.ItemTaxStatusUid).ValueGeneratedNever();
        });
        ...
        {
            entity.HasKey(e => e.ItsectionUid).HasFillFactor(90);

            entity.Property(e => e.ItsectionUid).HasDefaultValueSql("(newid())");
            entity.Property(e => e.CessGlCodeUid).HasDefaultValueSql("(NULL)");
            entity.Property(e => e.SurGlCodeUid).HasDefaultValueSql("(NULL)");
            entity.Property(e => e.TdsglCodeUid).HasDefaultValueSql("(NULL)");

            entity.HasOne(d => d.CessGlCodeU).WithMany(p => p.ItsectionMCessGlCodeUs).HasConstraintName("FK_ITSectionM_CessAccountM");

            entity.HasOne(d => d.SurGlCodeU).WithMany(p => p.ItsectionMSurGlCodeUs).HasConstraintName("FK_ITSectionM_SurAcccountM");

            entity.HasOne(d => d.TdsglCodeU).WithMany(p => p.ItsectionMTdsglCodeUs).HasConstraintName("FK_ITSectionM_TDSAccountM");
        });

        modelBuilder.Entity<JdaListM>(entity =>
        {
            entity.HasKey(e => e.PartyCode).HasFillFactor(90);

            entity.HasOne(d => d.PartyCodeNavigation).WithOne(p => p.JdaListM)
                .HasPrincipalKey<PartyM>(p => p.PartyCode)
                .HasForeignKey<JdaListM>(d => d.PartyCode)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_JDAList_PartyM");
        });

        modelBuilder.Entity<JobOrderResult>(entity =>
        {
            entity.Property(e => e.JobOrderResultsUid).ValueGeneratedNever();
            entity.Property(e => e.Asterisk).IsFixedLength();
        });

        modelBuilder.Entity<JobOrderResultsHdr>(entity =>
        {
            entity.HasKey(e => e.JobOrderResultsHdrUid).HasName("PK_JobOrderHdr");

            entity.Property(e => e.JobOrderResultsHdrUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<JobRequestHdr>(entity =>
        {
            entity.ToTable("JobRequestHdr", tb => tb.HasTrigger("TU_JobRequestHdr"));

            entity.Property(e => e.JobRequestHdrUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<JobRequestList>(entity =>
        {
            entity.Property(e => e.JobRequestListUid).ValueGeneratedNever();

            entity.HasOne(d => d.JobRequestHdrU).WithMany(p => p.JobRequestLists)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_JobRequestList_JobRequestHdr");
        });

        modelBuilder.Entity<JobRequestListExtn>(entity =>
        {
            entity.Property(e => e.JobRequestListExtnUid).ValueGeneratedNever();

            entity.HasOne(d => d.JobRequestListU).WithMany(p => p.JobRequestListExtns)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_JobRequestListExtn_JobRequestList");
        });
        ...
        {
            entity.HasKey(e => e.LedgerTemplatesUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.LiveMonthYearUid).HasFillFactor(90);

            entity.Property(e => e.LiveMonthYearUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<LockReleaseM>(entity =>
        {
            entity.Property(e => e.LockReleaseUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<MOpeningRate>(entity =>
        {
            entity.HasKey(e => e.InventoryTransListUid).HasFillFactor(90);

            entity.HasOne(d => d.InventoryTransListU).WithOne(p => p.MOpeningRate)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_M_OpeningRates_InventoryTransList");
        });

        modelBuilder.Entity<MdTurnoverMview>(entity =>
        {
            entity.Property(e => e.IsActive).HasDefaultValue(true);
            entity.Property(e => e.Isubgroupcode).IsFixedLength();
            entity.Property(e => e.Smonth).IsFixedLength();
            entity.Property(e => e.SproductGroup).IsFixedLength();
            entity.Property(e => e.SrowDisp).IsFixedLength();
            entity.Property(e => e.Stype).IsFixedLength();
            entity.Property(e => e.Syear).IsFixedLength();
        });

        modelBuilder.Entity<MdclassificationM>(entity =>
        {
            entity.ToView("MDClassificationM");
        });

        modelBuilder.Entity<MdstateM>(entity =>
        {
            entity.ToView("MDStateM");
        });

        modelBuilder.Entity<MedicalTran>(entity =>
        {
            entity.Property(e => e.MedicaltransUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<MedicaltransList>(entity =>
        {
            entity.Property(e => e.MedicaltransListUid).ValueGeneratedNever();
        });
        ...
        modelBuilder.Entity<MfstateDetail>(entity =>
        {
            entity.ToView("MFStateDetails");
        });

        modelBuilder.Entity<MonthEndAccountPostingStatus>(entity =>
        {
            entity.HasKey(e => e.MonthEndAccountPostingStatusUid).HasFillFactor(90);

            entity.Property(e => e.MonthEndAccountPostingStatusUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<MonthEndProcedureM>(entity =>
        {
            entity.HasKey(e => e.MonthEndProcedureUid).HasFillFactor(90);

            entity.Property(e => e.MonthEndProcedureUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<MonthEndProcessFlowHistory>(entity =>
        {
            entity.HasKey(e => e.MonthendProcessFlowHistoryUid).HasFillFactor(90);

            entity.ToTable("MonthEndProcessFlowHistory", tb => tb.HasTrigger("Tr_MonthEndProcessController"));

            entity.HasIndex(e => new { e.MonthEndStatusUid, e.Month, e.Year }, "UQ_Month_Year_Status")
                .IsUnique()
                .HasFillFactor(90);

            entity.Property(e => e.MonthendProcessFlowHistoryUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<MonthEndProcessFlowM>(entity =>
        {
            entity.HasKey(e => e.MonthEndStatusUid).HasFillFactor(90);

            entity.HasIndex(e => e.StatusCode, "UQ_StatusCode_MonthEndProcessFlowM").HasFillFactor(90);

            entity.Property(e => e.MonthEndStatusUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<MonthWiseReceiptIssueQtyOfStock>(entity =>
        {
            entity.ToView("MonthWiseReceiptIssueQtyOfStock");
        });

        modelBuilder.Entity<MonthendProcedureCheckList>(entity =>
        {
            entity.HasKey(e => e.MonthEndProcedureCheckListUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<OneTimeAddress>(entity =>
        {
            ...
            entity.HasIndex(e => e.InventoryTransUid, "IX_INVntorytransuid").HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.PartyCreditLimitHistoryUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<PartyCreditLimitM>(entity =>
        {
            ...
            entity.ToTable("PartyCreditLimitM", tb => tb.HasTrigger("Trg_PartyCreditLimitHistory"));

            entity.HasIndex(e => new { e.PartyUid, e.DivisionPrincipleUid, e.FinancialYearUid, e.IsActive }, "UK_PartyCreditLimitM").HasFillFactor(90);
        ...
        modelBuilder.Entity<PartyFreezeM>(entity =>
        {
            entity.Property(e => e.PartyIsFreezeUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<PartyKyc>(entity =>
        {
            entity.HasKey(e => e.PartyCode).HasFillFactor(90);
        });
        ...
        modelBuilder.Entity<PartyM>(entity =>
        {
            ...
            entity.ToTable("PartyM", tb =>
                {
                    ...
                    tb.HasTrigger("TI_AfterInsertPartyM");
                    tb.HasTrigger("TI_AfterUpdatePartyM");
            ...
            entity.HasIndex(e => new { e.AreaUid, e.PartyUid, e.PartyCode, e.PartyName }, "IX_Party_Area").HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.PartyTypeUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.PcrcancelledUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.Pcruid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.PhysicalStockVerificationEntryHeaderUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.PhysicalStockVerificationHeaderUid).HasFillFactor(90);

            entity.ToTable("PhysicalStockVerificationHeader", tb => tb.HasTrigger("TI_PhysicalStockVerificationHeader"));

            entity.Property(e => e.PhysicalStockVerificationHeaderUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<PlclassificationItemSubGroupMapping>(entity =>
        {
            entity.HasKey(e => e.PlclassificationItemSubGroupMappingUid).HasName("PK_PLClassificationItemSubGroupMapping_1");

            entity.Property(e => e.PlclassificationItemSubGroupMappingUid).ValueGeneratedNever();

            entity.HasOne(d => d.PlclassificationMu).WithMany(p => p.PlclassificationItemSubGroupMappings)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_PLClassificationItemSubGroupMapping_PLClassificationM");
        });

        modelBuilder.Entity<PlclassificationM>(entity =>
        {
            entity.Property(e => e.PlclassificationMuid).ValueGeneratedNever();
        });

        modelBuilder.Entity<Podetail>(entity =>
        {
            entity.HasKey(e => e.PolineUid).HasFillFactor(90);
            ...
            entity.HasIndex(e => e.ItemUid, "IX_ItemUID").HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.PoheaderUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<PoindentExemptedItemM>(entity =>
        {
            entity.Property(e => e.PoindentExemptedItemMuid).ValueGeneratedNever();
        });

        modelBuilder.Entity<Poschedule>(entity =>
        {
            entity.HasKey(e => e.PoscheduleUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<PreDefinedQuery>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasTrigger("TrgUpdate_predefined"));
        ...
        {
            entity.HasKey(e => e.PreferredDealerUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.PriceDiscountControlUid).HasFillFactor(90);

            entity.ToTable("PriceDiscountControlM", tb => tb.HasTrigger("Trg_PriceDiscountControlHistory"));
        ...
        {
            entity.HasKey(e => e.PrincipleSerialNumberUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.PrintUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.ProcessChargesUid).HasFillFactor(90);

            entity.HasIndex(e => e.ItemUid, "UQ_ProcessChargesM_ItemUID")
                .IsUnique()
                .HasFillFactor(90);

            entity.Property(e => e.ProcessChargesUid).ValueGeneratedNever();

            entity.HasOne(d => d.ItemU).WithOne(p => p.ProcessChargesM)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.ProcessSchemeUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<ProductionBatchBom>(entity =>
        {
            entity.ToTable("ProductionBatchBOM", tb => tb.HasTrigger("Trg_CalculateRRate"));
        });

        modelBuilder.Entity<ProductionLoss>(entity =>
        {
            entity.HasKey(e => e.ProductionLossUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.ProductionUid).HasFillFactor(90);

            entity.ToTable("ProductionM", tb => tb.HasTrigger("Trg_ToStopDeletion"));
        ...
        {
            entity.HasKey(e => e.ProformaInvoiceDetailUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.ProformaInvoiceHeaderUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<ProvisionalInoutRegister>(entity =>
        {
            entity.HasKey(e => e.RowUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.ProvisionalSchemeCreditNote1).HasFillFactor(90);

            entity.HasIndex(e => new { e.IsExtn, e.IsCreditNoteGenerated }, "IX_IsExtn").HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.PurchaseInvoiceDetailUid).HasFillFactor(90);

            entity.ToTable("PurchaseInvoiceDetail", tb => tb.HasTrigger("TI_PurchaseInvoiceDetailUID"));

            entity.HasIndex(e => new { e.InventoryTransListUid, e.IsActive, e.NetAmount }, "IX_").HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.PurchaseInvoiceDetailConsignmentUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.PurchaseInvoiceHeaderUid).HasFillFactor(90);

            entity.ToTable("PurchaseInvoiceHeader", tb =>
                {
                    tb.HasTrigger("PurchaseInvoiceHeaderGST");
                    tb.HasTrigger("TI_CostCalculation");
                    tb.HasTrigger("TI_PurchaseInvoiceHeaderUID");
                    tb.HasTrigger("TI_PurchaseInvoiceNo");
                });

            entity.HasIndex(e => e.PurchaseInvoiceNo, "IX_PurchaseInvoiceNo")
                .IsUnique()
                .HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.PurchaseOrderAdvanceUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.PurchaseOrderAdvanceAdjustmentUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.QuarterUid).HasFillFactor(90);
        ...
        {
            entity.HasIndex(e => e.CollectionTime, "idx_collection_time").IsClustered();

            entity.Property(e => e.QueryHash).IsFixedLength();
            entity.Property(e => e.QueryPlanHash).IsFixedLength();
        });
        ...
        modelBuilder.Entity<ROverHeadAnalysisOtherAccount>(entity =>
        {
            ...
            entity.Property(e => e.Division7Percent).HasDefaultValue(0m);
            entity.Property(e => e.Division8Percent).HasDefaultValue(0m);
        });

        modelBuilder.Entity<ROverheadServiceDivAllocation>(entity =>
        {
            entity.HasKey(e => e.OverheadServiceDivAllocationUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.RateTypeUid).HasFillFactor(90);

            entity.Property(e => e.RateTypeUid).HasDefaultValueSql("(newid())");
        });

        modelBuilder.Entity<RegistrationMDelete>(entity =>
        {
            entity.HasKey(e => e.RegistrationUid)
                .HasName("PK_RegistrationM")
                .HasFillFactor(90);

            entity.Property(e => e.RegistrationUid).ValueGeneratedNever();

            entity.HasOne(d => d.StateU).WithMany(p => p.RegistrationMDeletes)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.ItemUid, e.DivisionUid }).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => new { e.ItemUid, e.DivisionPrincipleUid }).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.ItemUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.ReportId).HasFillFactor(90);
        ...
        modelBuilder.Entity<RequestVoucherDetail>(entity =>
        {
            ...
            entity.HasIndex(e => e.RequestVoucherDetailUid, "IX_RequestVoucherDetail").HasFillFactor(90);
        ...
        modelBuilder.Entity<RequestVoucherDetailExtn>(entity =>
        {
            ...
            entity.HasIndex(e => e.InventoryTransListUid, "IX_Inventorytranslist_RequestvoucherHeader").HasFillFactor(90);

            entity.HasIndex(e => new { e.LnDivisionUid, e.RequestVoucherHeaderUid, e.InventoryTransListUid }, "IX_LineDiv_Requestvoucher_inventorytranslist").HasFillFactor(90);
        ...
        modelBuilder.Entity<RequestVoucherHeader>(entity =>
        {
            ...
            entity.HasIndex(e => e.IsActive, "IX_").HasFillFactor(90);
        ...
        modelBuilder.Entity<SalaryPosting>(entity =>
        {
            ...
            entity.HasOne(d => d.DivisionU).WithMany(p => p.SalaryPostings)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SalaryPosting_DivisionM");
        });
        ...
        modelBuilder.Entity<SaleOrderMobile>(entity =>
        {
            entity.HasKey(e => e.UniqId).HasName("PK__Sale_Ord__443B0BDE205F6FA2");

            entity.Property(e => e.UniqId).HasDefaultValueSql("(newid())");
        ...
        modelBuilder.Entity<SalesOfficersExecutivesMappingM>(entity =>
        {
            entity.Property(e => e.SalesOfficersExecutivesMappingMuid).ValueGeneratedNever();
        });
        ...
        {
            entity.HasKey(e => e.Schedule6GroupUid).HasFillFactor(90);

            entity.Property(e => e.Schedule6GroupUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<ScheduleGroupM>(entity =>
        {
            entity.HasKey(e => e.ScheduleGroupUid).HasFillFactor(90);

            entity.Property(e => e.ScheduleGroupUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<ScheduleM>(entity =>
        {
            entity.HasKey(e => e.ScheduleUid).HasFillFactor(90);

            entity.Property(e => e.ScheduleUid).ValueGeneratedNever();
            entity.Property(e => e.IsAdd).HasDefaultValue(false);
            entity.Property(e => e.IsGroupedAs).HasDefaultValueSql("(NULL)");
            entity.Property(e => e.IsTotal).HasDefaultValue(false);
        });

        modelBuilder.Entity<SchedulePrintOrder>(entity =>
        {
            entity.HasKey(e => e.Horder).HasFillFactor(90);
        });
        ...
        {
            entity.HasKey(e => e.SchemeCnrequestUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.SchemeGenerationUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => new { e.StateUid, e.Letter }).HasFillFactor(90);
        });

        modelBuilder.Entity<SecondarySupplierM>(entity =>
        {
            entity.HasKey(e => e.SecondarySupplierUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.SeedCategoryUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.SeedGovtDetailUid).HasFillFactor(90);

            entity.ToTable("SeedGovtDetail", tb => tb.HasTrigger("TrgSeed_opbBatchNoUpdate"));
        ...
        {
            entity.HasKey(e => e.SeedTypeUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.SingleInvoiceTradeDiscountExpUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<SmsreceiptDatum>(entity =>
        {
            entity.Property(e => e.VoucherheaderUid).ValueGeneratedNever();
        });
        ...
        {
            entity.HasKey(e => e.SodetailUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.SoforwardBranchUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<StanesSsisjobsNew>(entity =>
        {
            entity.Property(e => e.BranchCode).IsFixedLength();
        });
        ...
        {
            entity.HasKey(e => e.StateCommodityUid).HasFillFactor(90);

            entity.HasIndex(e => new { e.CommodityUid, e.StateUid }, "IX_StateCommodityM")
                .IsUnique()
                .HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.StateUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.StatusUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.StockPointCommisionAccountMappingUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.SpclinkUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.StockPointCommisionUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.StockPointDealermappingUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.SupVoucherMatchUid).HasFillFactor(90);

            entity.ToTable("SupVoucherMatch", tb => tb.HasTrigger("TI_ValidateSameDrCrUID"));

            entity.HasIndex(e => e.BillPassingUid, "IX_BillPassingDRUID").HasFillFactor(90);

            entity.HasIndex(e => e.IsActive, "IX_Isactive").HasFillFactor(90);

            entity.HasIndex(e => e.IsActive, "IX_IsactiveBillPassingCrUID").HasFillFactor(90);

            entity.HasIndex(e => new { e.CrVoucherUid, e.IsActive }, "IX_SupVoucherMatch_CrVoucherUID_IsActive_Includes").HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.SupplierControlCodeUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<SupplierWiseTdsper>(entity =>
        {
            entity.Property(e => e.SupplierWiseTdsperUid).ValueGeneratedNever();
        });
        ...
        {
            entity.HasKey(e => e.SyncDblistUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.SyncUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.SyncObjectUid).HasFillFactor(90);

            entity.Property(e => e.SyncObjectUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<TabIllPaymentRequestDatum>(entity =>
        {
            entity.Property(e => e.TabillRawId).ValueGeneratedNever();
            entity.Property(e => e.TapayRequestId).ValueGeneratedOnAdd();
        });

        modelBuilder.Entity<TabIllRawData1>(entity =>
        {
            entity.Property(e => e.ApprovedBy).IsFixedLength();
        });

        modelBuilder.Entity<TabIllRawDatum>(entity =>
        {
            entity.Property(e => e.ApprovedBy).IsFixedLength();
        });
        ...
        modelBuilder.Entity<TabillApproval08102024>(entity =>
        {
            entity.Property(e => e.Isactive).IsFixedLength();
        });

        modelBuilder.Entity<TabillApproved>(entity =>
        {
            entity.Property(e => e.TabillUid).ValueGeneratedNever();
            entity.Property(e => e.Isactive).IsFixedLength();
        });
        ...
        {
            entity.ToTable("TAEmployeeM", tb =>
                {
                    tb.HasTrigger("TAEmployeeM_InsteadOfDELETE");
                    tb.HasTrigger("TI_AfterUpdateTAEmployeeM");
                    tb.HasTrigger("TrgDel_TAEmployeeHistory");
                    tb.HasTrigger("Trg_AfterUpdateModification");
                    tb.HasTrigger("Trg_TAEmployeeHistory");
                });
        ...
        modelBuilder.Entity<TargetItemLinkMapping>(entity =>
        {
            entity.Property(e => e.TargetItemLinkUid).ValueGeneratedNever();

            entity.HasOne(d => d.ItemGroupU).WithMany(p => p.TargetItemLinkMappings).HasConstraintName("FK_TargetItemLinkMapping_ItemGroupM");

            entity.HasOne(d => d.ItemSubGroupU).WithMany(p => p.TargetItemLinkMappings).HasConstraintName("FK_TargetItemLinkMapping_ItemSubGroupM");

            entity.HasOne(d => d.ItemU).WithMany(p => p.TargetItemLinkMappings).HasConstraintName("FK_TargetItemLinkMapping_ItemM");

            entity.HasOne(d => d.TargetU).WithMany(p => p.TargetItemLinkMappings)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_TargetItemLinkMapping_TargetM");
        });
        ...
        modelBuilder.Entity<TargetMitemSubGroupMapping>(entity =>
        {
            entity.HasKey(e => e.TargetItemSubGroupUid).HasName("PK_TargetMItemGroupMapping");

            entity.Property(e => e.TargetItemSubGroupUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<TaxExemptedItemMaster>(entity =>
        {
            entity.HasKey(e => e.TaxExemptedItemMasterUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.TaxUid).HasFillFactor(80);
        ...
        {
            entity.HasKey(e => e.TaxTypeUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<TbaccountGroupM>(entity =>
        {
            entity.HasKey(e => e.TbaccountGroupUid).HasFillFactor(90);

            entity.Property(e => e.TbaccountGroupUid).ValueGeneratedNever();

            entity.HasOne(d => d.TbcontrolCodeU).WithMany(p => p.TbaccountGroupMs)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_TBControlCodeUID");
        });

        modelBuilder.Entity<TbaccountM>(entity =>
        {
            entity.HasKey(e => e.TbaccountUid).HasFillFactor(90);

            entity.HasIndex(e => new { e.TbcontrolCodeUid, e.TbaccountGroupUid }, "IX_TBControl_AGroup").HasFillFactor(90);

            entity.Property(e => e.TbaccountUid).ValueGeneratedNever();

            entity.HasOne(d => d.AccountU).WithMany(p => p.TbaccountMs)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AM_AccountUID");

            entity.HasOne(d => d.TbcontrolCodeU).WithMany(p => p.TbaccountMs)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AM_TBControlCodeUID");
        });

        modelBuilder.Entity<TbcontrolCodeM>(entity =>
        {
            entity.HasKey(e => e.TbcontrolCodeUid).HasFillFactor(90);

            entity.HasIndex(e => e.TbcontrolCodeUid, "FK_TBControlCodeM").HasFillFactor(90);

            entity.Property(e => e.TbcontrolCodeUid).ValueGeneratedNever();

            entity.HasOne(d => d.ControlAccountU).WithMany(p => p.TbcontrolCodeMs)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_TBControlAccountUID");
        });

        modelBuilder.Entity<TblAccount>(entity =>
        {
            entity.ToTable("TblAccount", tb => tb.HasTrigger("validate_debit_credit"));
        });

        modelBuilder.Entity<TempCrDay>(entity =>
        {
            entity.Property(e => e.BranchCode).IsFixedLength();
            entity.Property(e => e.DivisionCode).IsFixedLength();
            entity.Property(e => e.DivisionDesc).IsFixedLength();
            entity.Property(e => e.DivisionPrincipleName).IsFixedLength();
            entity.Property(e => e.FinancialYear).IsFixedLength();
            entity.Property(e => e.StateCode).IsFixedLength();
        });

        modelBuilder.Entity<TestMethodM>(entity =>
        {
            entity.Property(e => e.MethodUid).ValueGeneratedNever();
        });
        ...
        modelBuilder.Entity<TransactionTypeConfiguration>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.State, e.Branch, e.Division, e.Category, e.SubGroup, e.AccountUid }, "IX_State_Br_Div_cat_Subgrp_Account").HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.TransactionTypePurposeUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.TransactionTypePurposeLinkUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.TransactiontypesUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.TtcbranchUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.TtcstateUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.TtcsubGroupUid).HasFillFactor(90);

            entity.Property(e => e.TtcsubGroupUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<TurnoverMdLinksM>(entity =>
        {
            entity.Property(e => e.Disporder).IsFixedLength();
            entity.Property(e => e.LinkCodes).IsFixedLength();
            entity.Property(e => e.LinkDescription).IsFixedLength();
            entity.Property(e => e.LinkType).IsFixedLength();
            entity.Property(e => e.LinkUids).IsFixedLength();
            entity.Property(e => e.RowDisp).IsFixedLength();
        });

        modelBuilder.Entity<TyreRetreadingAttendedByM>(entity =>
        {
            entity.HasKey(e => e.TyreRetreadingAttendedByUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.Uomuid).HasFillFactor(90);
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.ToTable(tb =>
                {
                    tb.HasTrigger("ResignationDateUpdate");
                    tb.HasTrigger("UI_ResignationDateUpdate");
                });
        ...
        {
            entity.HasKey(e => e.UserTypeUid).HasFillFactor(90);

            entity.Property(e => e.UserTypeUid).ValueGeneratedNever();
        });

        modelBuilder.Entity<Vasummary>(entity =>
        {
            entity.ToView("VASummary");
        });

        modelBuilder.Entity<VatnotConsideredGroup>(entity =>
        {
            entity.HasKey(e => e.ItemGroupUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.VechicleTranUid).HasFillFactor(80);
        ...
        {
            entity.HasKey(e => e.VendorMappingUid).HasFillFactor(90);
            ...
            entity.ToTable("VoucherDetail", tb =>
                {
                    ...
                    tb.HasTrigger("TI_ValidatePartyDebitAmtCreditAmt");
                    tb.HasTrigger("TI_VoucherDetail_VoucherMatch");
                });

            entity.HasIndex(e => new { e.VoucherHeaderUid, e.IsActive }, "IX_DetailIsactive").HasFillFactor(90);

            entity.HasIndex(e => e.VoucherDetailUid, "IX_VoucherDetailUID").HasFillFactor(90);

            entity.HasIndex(e => new { e.IsActive, e.CreditAmt }, "IX_VoucherDetail_IsActive_CreditAmt_Includes").HasFillFactor(90);

            entity.HasIndex(e => new { e.IsActive, e.DebitAmt }, "IX_VoucherDetail_IsActive_DebitAmt_Includes").HasFillFactor(90);

            entity.HasIndex(e => new { e.AccountUid, e.CreatedDate }, "IX_Voucher_accountid").HasFillFactor(90);

            entity.HasIndex(e => new { e.AccountUid, e.IsActive }, "IX_accountUid_Isactive").HasFillFactor(90);
        ...
        modelBuilder.Entity<VoucherDetailExtn>(entity =>
        {
            ...
            entity.HasIndex(e => e.IsActive, "IX_ISActive_VH").HasFillFactor(90);

            entity.HasIndex(e => new { e.IsActive, e.InventoryTransListUid }, "IX_ISactive_InvlistUID").HasFillFactor(90);

            entity.HasIndex(e => e.IsActive, "IX_Isactive").HasFillFactor(90);

            entity.HasIndex(e => e.VoucherHeaderUid, "IX_VoucherDetailExtn_VoucherHeaderUID").HasFillFactor(90);
        ...
        modelBuilder.Entity<VoucherHeader>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.VoucherDate, e.DivisionUid }, "DateDiv").HasFillFactor(90);

            entity.HasIndex(e => new { e.DivisionUid, e.BranchUid }, "IX_").HasFillFactor(90);

            entity.HasIndex(e => e.BranchUid, "IX_Br").HasFillFactor(90);

            entity.HasIndex(e => new { e.BranchUid, e.DivisionUid }, "IX_BrDi").HasFillFactor(90);

            entity.HasIndex(e => new { e.BranchUid, e.IsActive }, "IX_BranchUIDISActive").HasFillFactor(90);

            entity.HasIndex(e => e.CreatedBy, "IX_Createdby").HasFillFactor(90);

            entity.HasIndex(e => new { e.HorefNo, e.IsActive }, "IX_HORefNoISactive").HasFillFactor(90);

            entity.HasIndex(e => e.IsActive, "IX_Isactive_VH_D_VRNo").HasFillFactor(90);

            entity.HasIndex(e => new { e.IsActive, e.VoucherDate }, "IX_Isactive_VouDate").HasFillFactor(90);

            entity.HasIndex(e => e.RefVoucherUid, "IX_RefVoucher_VoucherNoDate").HasFillFactor(90);

            entity.HasIndex(e => e.RequestNumber, "IX_RequestNuumber").HasFillFactor(90);

            entity.HasIndex(e => new { e.StatusUid, e.IsActive }, "IX_StatusUIDISactive").HasFillFactor(90);

            entity.HasIndex(e => new { e.TransactionTypePurposeTranUid, e.StatementNo, e.StatusUid }, "IX_Tr_St_StateMent").HasFillFactor(90);

            entity.HasIndex(e => new { e.TransactionTypeCode, e.VoucherDate, e.VoucherNo, e.DivisionUid }, "IX_TransactionType").HasFillFactor(90);

            entity.HasIndex(e => e.TransactionTypeCode, "IX_TransactionTypeCode").HasFillFactor(90);

            entity.HasIndex(e => e.BranchUid, "IX_VoucherHeader_BranchUID_Includes").HasFillFactor(90);

            entity.HasIndex(e => new { e.InPaymentOf, e.TransactionTypeCode, e.ChequeorDdno }, "IX_VoucherHeader_InPaymentOf_TransactionTypeCode_ChequeorDDNO").HasFillFactor(90);

            entity.HasIndex(e => e.InventoryTransUid, "IX_VoucherHeader_Inv").HasFillFactor(90);

            entity.HasIndex(e => new { e.StatusUid, e.IsActive }, "IX_VoucherHeader_StatusUID_IsActive_Includes").HasFillFactor(90);

            entity.HasIndex(e => new { e.VoucherHeaderUid, e.IsActive }, "IX_isactive").HasFillFactor(90);
        ...
        modelBuilder.Entity<VoucherHeaderExtn>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.IsIbt, e.VoucherHeaderUid }, "IX_ISIBT_VH").HasFillFactor(90);

            entity.HasIndex(e => e.RefPurchaseInvoiceHeaderUid, "IX_VoucherHeaderExtn_RefPurchaseInvoiceHeaderUID_Includes").HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.VoucherHoapprovedUid).HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.VoucherHotoApproveUid).HasFillFactor(90);
        ...
        modelBuilder.Entity<VoucherMatch>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.InventoryTransUid, e.IsActive }, "IX_InventorytransUID_ISactive").HasFillFactor(90);

            entity.HasIndex(e => new { e.CreditAmt, e.IsActive }, "IX_Isactive_CreditAmt").HasFillFactor(90);

            entity.HasIndex(e => new { e.DebitAmt, e.IsActive }, "IX_Isactive_DebitAmt").HasFillFactor(90);

            entity.HasIndex(e => new { e.PartyUid, e.DebitAmt, e.IsActive }, "IX_PartyUID_IsActive").HasFillFactor(90);

            entity.HasIndex(e => new { e.VoucherUid, e.CreatedDate }, "IX_Voucher").HasFillFactor(90);

            entity.HasIndex(e => new { e.VoucherMatchUid, e.TransType, e.TransactionTypePurposeTranUid, e.InventoryTransUid, e.VoucherUid, e.PartyUid }, "IX_VoucherMatch").HasFillFactor(90);
        ...
        modelBuilder.Entity<VoucherMatchLink>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.VoucherMatchCruid, e.CreatedDate }, "IX_VoucherMatch_CRLink").HasFillFactor(90);

            entity.HasIndex(e => new { e.VoucherMatchDruid, e.CreatedDate }, "IX_VoucherMatch_dbLink").HasFillFactor(90);
        ...
        modelBuilder.Entity<VwBsschedule>(entity =>
        {
            entity.ToView("Vw_BSSchedule");
        });
        ...
        modelBuilder.Entity<VwControlCodeM>(entity =>
        {
            entity.ToView("Vw_ControlCodeM");
        ...
        modelBuilder.Entity<VwDetailsOfStockTransferIssueforFreight>(entity =>
        {
            entity.ToView("VW_DetailsOfStockTransferIssueforFreight");
        });

        modelBuilder.Entity<VwDetailsOfStockTransferRecdGst>(entity =>
        {
            entity.ToView("VW_DetailsOfStockTransferRecdGST");
        });
        ...
        modelBuilder.Entity<VwDetailsOfStockTransferReceivedForFreight>(entity =>
        {
            entity.ToView("VW_DetailsOfStockTransferReceivedForFreight");
        });
        ...
        modelBuilder.Entity<VwDetailsofSalesReturn1>(entity =>
        {
            entity.ToView("VW_DetailsofSalesReturn1");
        });

        modelBuilder.Entity<VwDetailsofSalesRtnGst>(entity =>
        {
            entity.ToView("VW_DetailsofSalesRtnGST");
        });
        ...
        modelBuilder.Entity<VwInventoryLookupGrn>(entity =>
        {
            entity.ToView("Vw_inventoryLookup_GRN");
        });
        ...
        modelBuilder.Entity<VwItemRate30062017>(entity =>
        {
            entity.ToView("Vw_ItemRate30062017");
        });
        ...
        modelBuilder.Entity<VwLiftDetailsForSchemeWithType>(entity =>
        {
            entity.ToView("Vw_LiftDetailsForScheme_WithType");
        });
        ...
        modelBuilder.Entity<VwPartyCode>(entity =>
        {
            entity.ToView("VwPartyCode");
        });
        ...
        modelBuilder.Entity<VwPurchaseInvoiceforViewing>(entity =>
        {
            entity.ToView("Vw_PurchaseInvoiceforViewing");
        });
        ...
        modelBuilder.Entity<VwSchemeAppliedForWithType>(entity =>
        {
            entity.ToView("Vw_SchemeAppliedFor_WithType");
        });
        ...
        modelBuilder.Entity<VwSelectPurchaseInvoiceInventoryTransListUid1>(entity =>
        {
            entity.ToView("VW_SelectPurchaseInvoiceInventoryTransListUID1");
        });
        ...
        modelBuilder.Entity<VwStockTransferIssueDet>(entity =>
        {
            entity.ToView("VW_StockTransferIssueDet");
        });
        ...
        modelBuilder.Entity<VwTabillApproval>(entity =>
        {
            entity.ToView("Vw_TabillApproval");
        });
        ...
        modelBuilder.Entity<VwVoucherdetail1>(entity =>
        {
            entity.ToView("VW_VOUCHERDETAILS");
        });
