...
public partial class DivisionM
{
    ...
    [InverseProperty("DivisionU")]
    public virtual ICollection<CommissionM> CommissionMs { get; set; } = new List<CommissionM>();
    ...
    [InverseProperty("DivisionU")]
    public virtual ICollection<SalaryPosting> SalaryPostings { get; set; } = new List<SalaryPosting>();
