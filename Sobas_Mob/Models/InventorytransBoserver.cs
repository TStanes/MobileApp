...
[Keyless]
[Table("inventorytrans_Boserver")]
public partial class InventorytransBoserver
{
    ...
    [Column("ED", TypeName = "numeric(18, 3)")]
    public decimal Ed { get; set; }

    [Column("CESS", TypeName = "numeric(18, 3)")]
    public decimal Cess { get; set; }

    [Column("VAT", TypeName = "numeric(18, 3)")]
    public decimal Vat { get; set; }

    [Column("VATCESS", TypeName = "numeric(18, 3)")]
    ...
    [Column("RefInventoryTransUID", TypeName = "numeric(18, 0)")]
    public decimal? RefInventoryTransUid { get; set; }

    [Column("PreRAUID", TypeName = "numeric(18, 0)")]
